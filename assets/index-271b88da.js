...
`);const t={vertex:"GLTFDefaultMaterial",fragment:"GLTFDefaultMaterial"},i={attributes:["position"],uniforms:["worldView","projection","u_emission"],samplers:new Array,needAlphaBlending:!1};ne._DefaultMaterial=new Zi("GLTFDefaultMaterial",e,t,i),ne._DefaultMaterial.setColor4("u_emission",new qn(.5,.5,.5,1))}return ne._DefaultMaterial}}ne._DefaultMaterial=null;var He;(function(a){a[a.IDENTIFIER=1]="IDENTIFIER",a[a.UNKNOWN=2]="UNKNOWN",a[a.END_OF_INPUT=3]="END_OF_INPUT"})(He||(He={}));class Fi{constructor(e){this._pos=0,this.currentToken=He.UNKNOWN,this.currentIdentifier="",this.currentString="",this.isLetterOrDigitPattern=/^[a-zA-Z0-9]+$/,this._toParse=e,this._maxPos=e.length}getNextToken(){if(this.isEnd())return He.END_OF_INPUT;if(this.currentString=this.read(),this.currentToken=He.UNKNOWN,this.currentString==="_"||this.isLetterOrDigitPattern.test(this.currentString))for(this.currentToken=He.IDENTIFIER,this.currentIdentifier=this.currentString;!this.isEnd()&&(this.isLetterOrDigitPattern.test(this.currentString=this.peek())||this.currentString==="_");)this.currentIdentifier+=this.currentString,this.forward();return this.currentToken}peek(){return this._toParse[this._pos]}read(){return this._toParse[this._pos++]}forward(){this._pos++}isEnd(){return this._pos>=this._maxPos}}const sn=["MODEL","VIEW","PROJECTION","MODELVIEW","MODELVIEWPROJECTION","JOINTMATRIX"],rn=["world","view","projection","worldView","worldViewProjection","mBones"],Os=["translation","rotation","scale"],ys=["position","rotationQuaternion","scaling"],bs=(a,e)=>{for(const t in a){const i=a[t];e.buffers[t]=i,e.buffersCount++}},Ls=(a,e)=>{for(const t in a){const i=a[t];e.shaders[t]=i,e.shaderscount++}},fe=(a,e,t)=>{for(const i in a){const n=a[i];t[e][i]=n}},Ps=a=>{if(!!a)for(let e=0;e<a.length/2;e++)a[e*2+1]=1-a[e*2+1]},Bi=a=>{if(a.semantic==="NORMAL")return"normal";if(a.semantic==="POSITION")return"position";if(a.semantic==="JOINT")return"matricesIndices";if(a.semantic==="WEIGHT")return"matricesWeights";if(a.semantic==="COLOR")return"color";if(a.semantic&&a.semantic.indexOf("TEXCOORD_")!==-1){const e=Number(a.semantic.split("_")[1]);return"uv"+(e===0?"":e+1)}return null},Ds=a=>{for(const e in a.animations){const t=a.animations[e];if(!t.channels||!t.samplers)continue;let i=null;for(let n=0;n<t.channels.length;n++){const s=t.channels[n],r=t.samplers[s.sampler];if(!r)continue;let o=null,l=null;t.parameters?(o=t.parameters[r.input],l=t.parameters[r.output]):(o=r.input,l=r.output);const c=ne.GetBufferFromAccessor(a,a.accessors[o]),f=ne.GetBufferFromAccessor(a,a.accessors[l]),u=s.target.id;let h=a.scene.getNodeById(u);if(h===null&&(h=a.scene.getNodeByName(u)),h===null){G.Warn("Creating animation named "+e+". But cannot find node named "+u+" to attach to");continue}const _=h instanceof ze;let d=s.target.path;const E=Os.indexOf(d);E!==-1&&(d=ys[E]);let p=w.ANIMATIONTYPE_MATRIX;_||(d==="rotationQuaternion"?(p=w.ANIMATIONTYPE_QUATERNION,h.rotationQuaternion=new Ee):p=w.ANIMATIONTYPE_VECTOR3);let g=null;const R=[];let v=0,b=!1;_&&i&&i.getKeys().length===c.length&&(g=i,b=!0),b||(a.scene._blockEntityCollection=!!a.assetContainer,g=new w(e,_?"_matrix":d,1,p,w.ANIMATIONLOOPMODE_CYCLE),a.scene._blockEntityCollection=!1);for(let N=0;N<c.length;N++){let x=null;if(d==="rotationQuaternion"?(x=Ee.FromArray([f[v],f[v+1],f[v+2],f[v+3]]),v+=4):(x=A.FromArray([f[v],f[v+1],f[v+2]]),v+=3),_){const O=h;let D=A.Zero(),K=new Ee,Q=A.Zero(),ie=O.getBaseMatrix();b&&i&&(ie=i.getKeys()[N].value),ie.decompose(Q,K,D),d==="position"?D=x:d==="rotationQuaternion"?K=x:Q=x,x=X.Compose(Q,K,D)}b?i&&(i.getKeys()[N].value=x):R.push({frame:c[N],value:x})}!b&&g&&(g.setKeys(R),h.animations.push(g)),i=g,a.scene.stopAnimation(h),a.scene.beginAnimation(h,0,c[c.length-1],!0,1)}}},Ii=a=>{let e=null;if(a.translation||a.rotation||a.scale){const t=A.FromArray(a.scale||[1,1,1]),i=Ee.FromArray(a.rotation||[0,0,0,1]),n=A.FromArray(a.translation||[0,0,0]);e=X.Compose(t,i,n)}else e=X.FromArray(a.matrix);return e},an=(a,e,t,i)=>{for(let s=0;s<i.bones.length;s++)if(i.bones[s].name===t)return i.bones[s];const n=a.nodes;for(const s in n){const r=n[s];if(!r.jointName)continue;const o=r.children;for(let l=0;l<o.length;l++){const c=a.nodes[o[l]];if(!!c.jointName&&c.jointName===t){const f=Ii(r),u=new ze(r.name||"",i,an(a,e,r.jointName,i),f);return u.id=s,u}}}return null},Fs=(a,e)=>{for(let t=0;t<a.length;t++){const i=a[t];for(let n=0;n<i.node.children.length;n++)if(i.node.children[n]===e)return i.bone}return null},wt=(a,e)=>{const t=a.nodes;let i=t[e];if(i)return{node:i,id:e};for(const n in t)if(i=t[n],i.jointName===e)return{node:i,id:n};return null},Bs=(a,e)=>{for(let t=0;t<a.jointNames.length;t++)if(a.jointNames[t]===e)return!0;return!1},Us=(a,e,t,i)=>{for(const n in a.nodes){const s=a.nodes[n],r=n;if(!s.jointName||Bs(t,s.jointName))continue;const o=Ii(s),l=new ze(s.name||"",e,null,o);l.id=r,i.push({bone:l,node:s,id:r})}for(let n=0;n<i.length;n++){const s=i[n],r=s.node.children;for(let o=0;o<r.length;o++){let l=null;for(let c=0;c<i.length;c++)if(i[c].id===r[o]){l=i[c];break}l&&(l.bone._parent=s.bone,s.bone.children.push(l.bone))}}},ws=(a,e,t,i)=>{if(i||(i=new it(e.name||"","",a.scene)),!e.babylonSkeleton)return i;const n=[],s=[];Us(a,i,e,n),i.bones=[];for(let o=0;o<e.jointNames.length;o++){const l=wt(a,e.jointNames[o]);if(!l)continue;const c=l.node;if(!c){G.Warn("Joint named "+e.jointNames[o]+" does not exist");continue}const f=l.id,u=a.scene.getBoneById(f);if(u){i.bones.push(u);continue}let h=!1,_=null;for(let p=0;p<o;p++){const g=wt(a,e.jointNames[p]);if(!g)continue;const R=g.node;if(!R){G.Warn("Joint named "+e.jointNames[p]+" does not exist when looking for parent");continue}const v=R.children;if(!!v){h=!1;for(let b=0;b<v.length;b++)if(v[b]===f){_=an(a,e,e.jointNames[p],i),h=!0;break}if(h)break}}const d=Ii(c);!_&&n.length>0&&(_=Fs(n,f),_&&s.indexOf(_)===-1&&s.push(_));const E=new ze(c.jointName||"",i,_,d);E.id=f}const r=i.bones;i.bones=[];for(let o=0;o<e.jointNames.length;o++){const l=wt(a,e.jointNames[o]);if(!!l){for(let c=0;c<r.length;c++)if(r[c].id===l.id){i.bones.push(r[c]);break}}}i.prepare();for(let o=0;o<s.length;o++)i.bones.push(s[o]);return i},Ui=(a,e,t,i,n)=>{if(n||(a.scene._blockEntityCollection=!!a.assetContainer,n=new se(e.name||"",a.scene),n._parentContainer=a.assetContainer,a.scene._blockEntityCollection=!1,n.id=i),!e.babylonNode)return n;const s=[];let r=null;const o=new Array,l=new Array,c=new Array,f=new Array;for(let _=0;_<t.length;_++){const d=t[_],E=a.meshes[d];if(!!E)for(let p=0;p<E.primitives.length;p++){const g=new kt,R=E.primitives[p];R.mode;const v=R.attributes;let b=null,N=null;for(const O in v)if(b=a.accessors[v[O]],N=ne.GetBufferFromAccessor(a,b),O==="NORMAL")g.normals=new Float32Array(N.length),g.normals.set(N);else if(O==="POSITION"){if(Z.HomogeneousCoordinates){g.positions=new Float32Array(N.length-N.length/4);for(let D=0;D<N.length;D+=4)g.positions[D]=N[D],g.positions[D+1]=N[D+1],g.positions[D+2]=N[D+2]}else g.positions=new Float32Array(N.length),g.positions.set(N);l.push(g.positions.length)}else if(O.indexOf("TEXCOORD_")!==-1){const D=Number(O.split("_")[1]),K=y.UVKind+(D===0?"":D+1),Q=new Float32Array(N.length);Q.set(N),Ps(Q),g.set(Q,K)}else O==="JOINT"?(g.matricesIndices=new Float32Array(N.length),g.matricesIndices.set(N)):O==="WEIGHT"?(g.matricesWeights=new Float32Array(N.length),g.matricesWeights.set(N)):O==="COLOR"&&(g.colors=new Float32Array(N.length),g.colors.set(N));if(b=a.accessors[R.indices],b)N=ne.GetBufferFromAccessor(a,b),g.indices=new Int32Array(N.length),g.indices.set(N),f.push(g.indices.length);else{const O=[];for(let D=0;D<g.positions.length/3;D++)O.push(D);g.indices=new Int32Array(O),f.push(g.indices.length)}r?r.merge(g):r=g;const x=a.scene.getMaterialById(R.material);s.push(x===null?ne.GetDefaultMaterial(a.scene):x),o.push(o.length===0?0:o[o.length-1]+l[l.length-2]),c.push(c.length===0?0:c[c.length-1]+f[f.length-2])}}let u;a.scene._blockEntityCollection=!!a.assetContainer,s.length>1?(u=new Jn("multimat"+i,a.scene),u.subMaterials=s):u=new Ri("multimat"+i,a.scene),s.length===1&&(u=s[0]),u._parentContainer=a.assetContainer,n.material||(n.material=u),new Ci(i,a.scene,r,!1,n),n.computeWorldMatrix(!0),a.scene._blockEntityCollection=!1,n.subMeshes=[];let h=0;for(let _=0;_<t.length;_++){const d=t[_],E=a.meshes[d];if(!!E)for(let p=0;p<E.primitives.length;p++)E.primitives[p].mode,$n.AddToMesh(h,o[h],l[h],c[h],f[h],n,n,!0),h++}return n},zt=(a,e,t,i)=>{a.position&&(a.position=e),(a.rotationQuaternion||a.rotation)&&(a.rotationQuaternion=t),a.scaling&&(a.scaling=i)},Gs=(a,e)=>{if(e.matrix){const t=new A(0,0,0),i=new Ee,n=new A(0,0,0);X.FromArray(e.matrix).decompose(n,i,t),zt(a,t,i,n)}else e.translation&&e.rotation&&e.scale&&zt(a,A.FromArray(e.translation),Ee.FromArray(e.rotation),A.FromArray(e.scale));a.computeWorldMatrix(!0)},Vs=(a,e,t)=>{let i=null;if(a.importOnlyMeshes&&(e.skin||e.meshes)&&a.importMeshesNames&&a.importMeshesNames.length>0&&a.importMeshesNames.indexOf(e.name||"")===-1)return null;if(e.skin){if(e.meshes){const n=a.skins[e.skin],s=Ui(a,e,e.meshes,t,e.babylonNode);s.skeleton=a.scene.getLastSkeletonById(e.skin),s.skeleton===null&&(s.skeleton=ws(a,n,s,n.babylonSkeleton),n.babylonSkeleton||(n.babylonSkeleton=s.skeleton)),i=s}}else if(e.meshes)i=Ui(a,e,e.mesh?[e.mesh]:e.meshes,t,e.babylonNode);else if(e.light&&!e.babylonNode&&!a.importOnlyMeshes){const n=a.lights[e.light];if(n){if(n.type==="ambient"){const s=n[n.type],r=new Ji(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=V.FromArray(s.color)),i=r}else if(n.type==="directional"){const s=n[n.type],r=new Ce(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=V.FromArray(s.color)),i=r}else if(n.type==="point"){const s=n[n.type],r=new mt(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=V.FromArray(s.color)),i=r}else if(n.type==="spot"){const s=n[n.type],r=new pe(e.light,A.Zero(),A.Zero(),0,0,a.scene);r.name=e.name||"",s.color&&(r.diffuse=V.FromArray(s.color)),s.fallOfAngle&&(r.angle=s.fallOfAngle),s.fallOffExponent&&(r.exponent=s.fallOffExponent),i=r}}}else if(e.camera&&!e.babylonNode&&!a.importOnlyMeshes){const n=a.cameras[e.camera];if(n){if(a.scene._blockEntityCollection=!!a.assetContainer,n.type==="orthographic"){const s=new We(e.camera,A.Zero(),a.scene,!1);s.name=e.name||"",s.mode=$i.ORTHOGRAPHIC_CAMERA,s.attachControl(),i=s,s._parentContainer=a.assetContainer}else if(n.type==="perspective"){const s=n[n.type],r=new We(e.camera,A.Zero(),a.scene,!1);r.name=e.name||"",r.attachControl(),s.aspectRatio||(s.aspectRatio=a.scene.getEngine().getRenderWidth()/a.scene.getEngine().getRenderHeight()),s.znear&&s.zfar&&(r.maxZ=s.zfar,r.minZ=s.znear),i=r,r._parentContainer=a.assetContainer}a.scene._blockEntityCollection=!1}}if(!e.jointName){if(e.babylonNode)return e.babylonNode;if(i===null){a.scene._blockEntityCollection=!!a.assetContainer;const n=new se(e.name||"",a.scene);n._parentContainer=a.assetContainer,a.scene._blockEntityCollection=!1,e.babylonNode=n,i=n}}if(i!==null){if(e.matrix&&i instanceof se)Gs(i,e);else{const n=e.translation||[0,0,0],s=e.rotation||[0,0,0,1],r=e.scale||[1,1,1];zt(i,A.FromArray(n),Ee.FromArray(s),A.FromArray(r))}i.updateCache(!0),e.babylonNode=i}return i},ut=(a,e,t,i=!1)=>{const n=a.nodes[e];let s=null;if(a.importOnlyMeshes&&!i&&a.importMeshesNames?a.importMeshesNames.indexOf(n.name||"")!==-1||a.importMeshesNames.length===0?i=!0:i=!1:i=!0,!n.jointName&&i&&(s=Vs(a,n,e),s!==null&&(s.id=e,s.parent=t)),n.children)for(let r=0;r<n.children.length;r++)ut(a,n.children[r],s,i)},wi=a=>{let e=a.currentScene;if(e)for(let t=0;t<e.nodes.length;t++)ut(a,e.nodes[t],null);else for(const t in a.scenes){e=a.scenes[t];for(let i=0;i<e.nodes.length;i++)ut(a,e.nodes[i],null)}Ds(a);for(let t=0;t<a.scene.skeletons.length;t++){const i=a.scene.skeletons[t];a.scene.beginAnimation(i,0,Number.MAX_VALUE,!0,1)}},Hs=(a,e,t,i,n,s,r)=>{const o=s.values||n.parameters;for(const l in t){const c=t[l],f=c.type;if(f===ue.FLOAT_MAT2||f===ue.FLOAT_MAT3||f===ue.FLOAT_MAT4){if(c.semantic&&!c.source&&!c.node)ne.SetMatrix(e.scene,a,c,l,i.getEffect());else if(c.semantic&&(c.source||c.node)){let u=e.scene.getNodeByName(c.source||c.node||"");if(u===null&&(u=e.scene.getNodeById(c.source||c.node||"")),u===null)continue;ne.SetMatrix(e.scene,u,c,l,i.getEffect())}}else{const u=o[n.uniforms[l]];if(!u)continue;if(f===ue.SAMPLER_2D){const h=e.textures[s.values?u:c.value].babylonTexture;if(h==null)continue;i.getEffect().setTexture(l,h)}else ne.SetUniform(i.getEffect(),l,u,f)}}r(i)},ks=(a,e,t,i,n)=>{const s=i.values||t.parameters,r=t.uniforms;for(const o in n){const l=n[o],c=l.type;let f=s[r[o]];if(f===void 0&&(f=l.value),!f)continue;const u=h=>_=>{l.value&&h&&(e.setTexture(h,_),delete n[h])};c===ue.SAMPLER_2D?re.LoadTextureAsync(a,i.values?f:l.value,u(o),()=>u(null)):l.value&&ne.SetUniform(e,o,i.values?f:l.value,c)&&delete n[o]}},Xs=(a,e,t)=>(i,n)=>{e.dispose(!0),t("Cannot compile program named "+a.name+". Error: "+n+". Default material will be applied")},Ys=(a,e,t,i,n,s)=>r=>{ks(a,e,t,i,n),e.onBind=o=>{Hs(o,a,n,e,t,i,s)}},Gi=(a,e,t)=>{for(const i in e.uniforms){const n=e.uniforms[i],s=e.parameters[n];if(a.currentIdentifier===i&&s.semantic&&!s.source&&!s.node){const r=sn.indexOf(s.semantic);if(r!==-1)return delete t[i],rn[r]}}return a.currentIdentifier},Vi=a=>{for(const e in a.materials)re.LoadMaterialAsync(a,e,()=>{},()=>{})};class Me{static CreateRuntime(e,t,i){const n={extensions:{},accessors:{},buffers:{},bufferViews:{},meshes:{},lights:{},cameras:{},nodes:{},images:{},textures:{},shaders:{},programs:{},samplers:{},techniques:{},materials:{},animations:{},skins:{},extensionsUsed:[],scenes:{},buffersCount:0,shaderscount:0,scene:t,rootUrl:i,loadedBufferCount:0,loadedBufferViews:{},loadedShaderCount:0,importOnlyMeshes:!1,dummyNodes:[],assetContainer:null};return e.extensions&&fe(e.extensions,"extensions",n),e.extensionsUsed&&fe(e.extensionsUsed,"extensionsUsed",n),e.buffers&&bs(e.buffers,n),e.bufferViews&&fe(e.bufferViews,"bufferViews",n),e.accessors&&fe(e.accessors,"accessors",n),e.meshes&&fe(e.meshes,"meshes",n),e.lights&&fe(e.lights,"lights",n),e.cameras&&fe(e.cameras,"cameras",n),e.nodes&&fe(e.nodes,"nodes",n),e.images&&fe(e.images,"images",n),e.textures&&fe(e.textures,"textures",n),e.shaders&&Ls(e.shaders,n),e.programs&&fe(e.programs,"programs",n),e.samplers&&fe(e.samplers,"samplers",n),e.techniques&&fe(e.techniques,"techniques",n),e.materials&&fe(e.materials,"materials",n),e.animations&&fe(e.animations,"animations",n),e.skins&&fe(e.skins,"skins",n),e.scenes&&(n.scenes=e.scenes),e.scene&&e.scenes&&(n.currentScene=e.scenes[e.scene]),n}static LoadBufferAsync(e,t,i,n,s){const r=e.buffers[t];G.IsBase64(r.uri)?setTimeout(()=>i(new Uint8Array(G.DecodeBase64(r.uri)))):G.LoadFile(e.rootUrl+r.uri,o=>i(new Uint8Array(o)),s,void 0,!0,o=>{o&&n(o.status+" "+o.statusText)})}static LoadTextureBufferAsync(e,t,i,n){const s=e.textures[t];if(!s||!s.source){n("");return}if(s.babylonTexture){i(null);return}const r=e.images[s.source];G.IsBase64(r.uri)?setTimeout(()=>i(new Uint8Array(G.DecodeBase64(r.uri)))):G.LoadFile(e.rootUrl+r.uri,o=>i(new Uint8Array(o)),void 0,void 0,!0,o=>{o&&n(o.status+" "+o.statusText)})}static CreateTextureAsync(e,t,i,n){const s=e.textures[t];if(s.babylonTexture){n(s.babylonTexture);return}const r=e.samplers[s.sampler],o=r.minFilter===Re.NEAREST_MIPMAP_NEAREST||r.minFilter===Re.NEAREST_MIPMAP_LINEAR||r.minFilter===Re.LINEAR_MIPMAP_NEAREST||r.minFilter===Re.LINEAR_MIPMAP_LINEAR,l=U.BILINEAR_SAMPLINGMODE,c=i==null?new Blob:new Blob([i]),f=URL.createObjectURL(c),u=()=>URL.revokeObjectURL(f),h=new U(f,e.scene,!o,!0,l,u,u);r.wrapS!==void 0&&(h.wrapU=ne.GetWrapMode(r.wrapS)),r.wrapT!==void 0&&(h.wrapV=ne.GetWrapMode(r.wrapT)),h.name=t,s.babylonTexture=h,n(h)}static LoadShaderStringAsync(e,t,i,n){const s=e.shaders[t];if(G.IsBase64(s.uri)){const r=atob(s.uri.split(",")[1]);i&&i(r)}else G.LoadFile(e.rootUrl+s.uri,i,void 0,void 0,!1,r=>{r&&n&&n(r.status+" "+r.statusText)})}static LoadMaterialAsync(e,t,i,n){const s=e.materials[t];if(!s.technique){n&&n("No technique found.");return}const r=e.techniques[s.technique];if(!r){e.scene._blockEntityCollection=!!e.assetContainer;const x=new Ri(t,e.scene);x._parentContainer=e.assetContainer,e.scene._blockEntityCollection=!1,x.diffuseColor=new V(.5,.5,.5),x.sideOrientation=le.CounterClockWiseSideOrientation,i(x);return}const o=e.programs[r.program],l=r.states,c=Ve.ShadersStore[o.vertexShader+"VertexShader"],f=Ve.ShadersStore[o.fragmentShader+"PixelShader"];let u="",h="";const _=new Fi(c),d=new Fi(f),E={},p=[],g=[],R=[];for(const x in r.uniforms){const O=r.uniforms[x],D=r.parameters[O];if(E[x]=D,D.semantic&&!D.node&&!D.source){const K=sn.indexOf(D.semantic);K!==-1?(p.push(rn[K]),delete E[x]):p.push(x)}else D.type===ue.SAMPLER_2D?R.push(x):p.push(x)}for(const x in r.attributes){const O=r.attributes[x],D=r.parameters[O];if(D.semantic){const K=Bi(D);K&&g.push(K)}}for(;!_.isEnd()&&_.getNextToken();){if(_.currentToken!==He.IDENTIFIER){u+=_.currentString;continue}let O=!1;for(const D in r.attributes){const K=r.attributes[D],Q=r.parameters[K];if(_.currentIdentifier===D&&Q.semantic){u+=Bi(Q),O=!0;break}}O||(u+=Gi(_,r,E))}for(;!d.isEnd()&&d.getNextToken();){if(d.currentToken!==He.IDENTIFIER){h+=d.currentString;continue}h+=Gi(d,r,E)}const v={vertex:o.vertexShader+t,fragment:o.fragmentShader+t},b={attributes:g,uniforms:p,samplers:R,needAlphaBlending:l&&l.enable&&l.enable.indexOf(3042)!==-1};Ve.ShadersStore[o.vertexShader+t+"VertexShader"]=u,Ve.ShadersStore[o.fragmentShader+t+"PixelShader"]=h;const N=new Zi(t,e.scene,v,b);if(N.onError=Xs(o,N,n),N.onCompiled=Ys(e,N,r,s,E,i),N.sideOrientation=le.CounterClockWiseSideOrientation,l&&l.functions){const x=l.functions;x.cullFace&&x.cullFace[0]!==St.BACK&&(N.backFaceCulling=!1);const O=x.blendFuncSeparate;O&&(O[0]===J.SRC_ALPHA&&O[1]===J.ONE_MINUS_SRC_ALPHA&&O[2]===J.ONE&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_COMBINE:O[0]===J.ONE&&O[1]===J.ONE&&O[2]===J.ZERO&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_ONEONE:O[0]===J.SRC_ALPHA&&O[1]===J.ONE&&O[2]===J.ZERO&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_ADD:O[0]===J.ZERO&&O[1]===J.ONE_MINUS_SRC_COLOR&&O[2]===J.ONE&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_SUBTRACT:O[0]===J.DST_COLOR&&O[1]===J.ZERO&&O[2]===J.ONE&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_MULTIPLY:O[0]===J.SRC_ALPHA&&O[1]===J.ONE_MINUS_SRC_COLOR&&O[2]===J.ONE&&O[3]===J.ONE&&(N.alphaMode=ke.ALPHA_MAXIMIZED))}}}let Ge=class{static RegisterExtension(e){if(Ge.Extensions[e.name]){G.Error('Tool with the same name "'+e.name+'" already exists');return}Ge.Extensions[e.name]=e}dispose(){}_importMeshAsync(e,t,i,n,s,r,o,l){return t.useRightHandedSystem=!0,re.LoadRuntimeAsync(t,i,n,c=>{c.assetContainer=s,c.importOnlyMeshes=!0,e===""?c.importMeshesNames=[]:typeof e=="string"?c.importMeshesNames=[e]:e&&!(e instanceof Array)?c.importMeshesNames=[e]:(c.importMeshesNames=[],G.Warn("Argument meshesNames must be of type string or string[]")),this._createNodes(c);const f=new Array,u=new Array;for(const h in c.nodes){const _=c.nodes[h];_.babylonNode instanceof Zn&&f.push(_.babylonNode)}for(const h in c.skins){const _=c.skins[h];_.babylonSkeleton instanceof it&&u.push(_.babylonSkeleton)}this._loadBuffersAsync(c,()=>{this._loadShadersAsync(c,()=>{Vi(c),wi(c),!Z.IncrementalLoading&&r&&r(f,u)})}),Z.IncrementalLoading&&r&&r(f,u)},l),!0}importMeshAsync(e,t,i,n,s,r){return new Promise((o,l)=>{this._importMeshAsync(e,t,n,s,i,(c,f)=>{o({meshes:c,particleSystems:[],skeletons:f,animationGroups:[],lights:[],transformNodes:[],geometries:[]})},r,c=>{l(new Error(c))})})}_loadAsync(e,t,i,n,s,r){e.useRightHandedSystem=!0,re.LoadRuntimeAsync(e,t,i,o=>{re.LoadRuntimeExtensionsAsync(o,()=>{this._createNodes(o),this._loadBuffersAsync(o,()=>{this._loadShadersAsync(o,()=>{Vi(o),wi(o),Z.IncrementalLoading||n()})}),Z.IncrementalLoading&&n()},r)},r)}loadAsync(e,t,i,n){return new Promise((s,r)=>{this._loadAsync(e,t,i,()=>{s()},n,o=>{r(new Error(o))})})}_loadShadersAsync(e,t){let i=!1;const n=(s,r)=>{re.LoadShaderStringAsync(e,s,o=>{o instanceof ArrayBuffer||(e.loadedShaderCount++,o&&(Ve.ShadersStore[s+(r.type===Ct.VERTEX?"VertexShader":"PixelShader")]=o),e.loadedShaderCount===e.shaderscount&&t())},()=>{G.Error("Error when loading shader program named "+s+" located at "+r.uri)})};for(const s in e.shaders){i=!0;const r=e.shaders[s];r?n.bind(this,s,r)():G.Error("No shader named: "+s)}i||t()}_loadBuffersAsync(e,t){let i=!1;const n=(s,r)=>{re.LoadBufferAsync(e,s,o=>{e.loadedBufferCount++,o&&(o.byteLength!=e.buffers[s].byteLength&&G.Error("Buffer named "+s+" is length "+o.byteLength+". Expected: "+r.byteLength),e.loadedBufferViews[s]=o),e.loadedBufferCount===e.buffersCount&&t()},()=>{G.Error("Error when loading buffer named "+s+" located at "+r.uri)})};for(const s in e.buffers){i=!0;const r=e.buffers[s];r?n.bind(this,s,r)():G.Error("No buffer named: "+s)}i||t()}_createNodes(e){let t=e.currentScene;if(t)for(let i=0;i<t.nodes.length;i++)ut(e,t.nodes[i],null);else for(const i in e.scenes){t=e.scenes[i];for(let n=0;n<t.nodes.length;n++)ut(e,t.nodes[n],null)}}};Ge.Extensions={};class re{constructor(e){this._name=e}get name(){return this._name}loadRuntimeAsync(e,t,i,n,s){return!1}loadRuntimeExtensionsAsync(e,t,i){return!1}loadBufferAsync(e,t,i,n,s){return!1}loadTextureBufferAsync(e,t,i,n){return!1}createTextureAsync(e,t,i,n,s){return!1}loadShaderStringAsync(e,t,i,n){return!1}loadMaterialAsync(e,t,i,n){return!1}static LoadRuntimeAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.loadRuntimeAsync(e,t,i,n,s),()=>{setTimeout(()=>{!n||n(Me.CreateRuntime(t.json,e,i))})})}static LoadRuntimeExtensionsAsync(e,t,i){re._ApplyExtensions(n=>n.loadRuntimeExtensionsAsync(e,t,i),()=>{setTimeout(()=>{t()})})}static LoadBufferAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.loadBufferAsync(e,t,i,n,s),()=>{Me.LoadBufferAsync(e,t,i,n,s)})}static LoadTextureAsync(e,t,i,n){re._LoadTextureBufferAsync(e,t,s=>{s&&re._CreateTextureAsync(e,t,s,i,n)},n)}static LoadShaderStringAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadShaderStringAsync(e,t,i,n),()=>{Me.LoadShaderStringAsync(e,t,i,n)})}static LoadMaterialAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadMaterialAsync(e,t,i,n),()=>{Me.LoadMaterialAsync(e,t,i,n)})}static _LoadTextureBufferAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadTextureBufferAsync(e,t,i,n),()=>{Me.LoadTextureBufferAsync(e,t,i,n)})}static _CreateTextureAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.createTextureAsync(e,t,i,n,s),()=>{Me.CreateTextureAsync(e,t,i,n)})}static _ApplyExtensions(e,t){for(const i in Ge.Extensions){const n=Ge.Extensions[i];if(e(n))return}t()}}Z._CreateGLTF1Loader=()=>new Ge;const zs="binary_glTF";class on extends re{constructor(){super("KHR_binary_glTF")}loadRuntimeAsync(e,t,i,n){const s=t.json.extensionsUsed;return!s||s.indexOf(this.name)===-1||!t.bin?!1:(this._bin=t.bin,n(Me.CreateRuntime(t.json,e,i)),!0)}loadBufferAsync(e,t,i,n){return e.extensionsUsed.indexOf(this.name)===-1||t!==zs?!1:(this._bin.readAsync(0,this._bin.byteLength).then(i,s=>n(s.message)),!0)}loadTextureBufferAsync(e,t,i){const n=e.textures[t],s=e.images[n.source];if(!s.extensions||!(this.name in s.extensions))return!1;const r=s.extensions[this.name],o=e.bufferViews[r.bufferView],l=ne.GetBufferFromBufferView(e,o,0,o.byteLength,Ue.UNSIGNED_BYTE);return i(l),!0}loadShaderStringAsync(e,t,i){const n=e.shaders[t];if(!n.extensions||!(this.name in n.extensions))return!1;const s=n.extensions[this.name],r=e.bufferViews[s.bufferView],o=ne.GetBufferFromBufferView(e,r,0,r.byteLength,Ue.UNSIGNED_BYTE);return setTimeout(()=>{const l=ne.DecodeBufferToText(o);i(l)}),!0}}Ge.RegisterExtension(new on);class ln extends re{constructor(){super("KHR_materials_common")}loadRuntimeExtensionsAsync(e){if(!e.extensions)return!1;const t=e.extensions[this.name];if(!t)return!1;const i=t.lights;if(i)for(const n in i){const s=i[n];switch(s.type){case"ambient":{const r=new Ji(s.name,new A(0,1,0),e.scene),o=s.ambient;o&&(r.diffuse=V.FromArray(o.color||[1,1,1]));break}case"point":{const r=new mt(s.name,new A(10,10,10),e.scene),o=s.point;o&&(r.diffuse=V.FromArray(o.color||[1,1,1]));break}case"directional":{const r=new Ce(s.name,new A(0,-1,0),e.scene),o=s.directional;o&&(r.diffuse=V.FromArray(o.color||[1,1,1]));break}case"spot":{const r=s.spot;if(r){const o=new pe(s.name,new A(0,10,0),new A(0,-1,0),r.fallOffAngle||Math.PI,r.fallOffExponent||0,e.scene);o.diffuse=V.FromArray(r.color||[1,1,1])}break}default:G.Warn('GLTF Material Common extension: light type "'+s.type+"” not supported");break}}return!1}loadMaterialAsync(e,t,i,n){const s=e.materials[t];if(!s||!s.extensions)return!1;const r=s.extensions[this.name];if(!r)return!1;const o=new Ri(t,e.scene);return o.sideOrientation=le.CounterClockWiseSideOrientation,r.technique==="CONSTANT"&&(o.disableLighting=!0),o.backFaceCulling=r.doubleSided===void 0?!1:!r.doubleSided,o.alpha=r.values.transparency===void 0?1:r.values.transparency,o.specularPower=r.values.shininess===void 0?0:r.values.shininess,typeof r.values.ambient=="string"?this._loadTexture(e,r.values.ambient,o,"ambientTexture",n):o.ambientColor=V.FromArray(r.values.ambient||[0,0,0]),typeof r.values.diffuse=="string"?this._loadTexture(e,r.values.diffuse,o,"diffuseTexture",n):o.diffuseColor=V.FromArray(r.values.diffuse||[0,0,0]),typeof r.values.emission=="string"?this._loadTexture(e,r.values.emission,o,"emissiveTexture",n):o.emissiveColor=V.FromArray(r.values.emission||[0,0,0]),typeof r.values.specular=="string"?this._loadTexture(e,r.values.specular,o,"specularTexture",n):o.specularColor=V.FromArray(r.values.specular||[0,0,0]),!0}_loadTexture(e,t,i,n,s){Me.LoadTextureBufferAsync(e,t,r=>{Me.CreateTextureAsync(e,t,r,o=>i[n]=o)},s)}}Ge.RegisterExtension(new ln);var ro=Object.freeze({__proto__:null,GLTFBinaryExtension:on,GLTFLoaderBase:Me,GLTFLoader:Ge,GLTFLoaderExtension:re,get EComponentType(){return Ue},get EShaderType(){return Ct},get EParameterType(){return ue},get ETextureWrapMode(){return $e},get ETextureFilterType(){return Re},get ETextureFormat(){return Yt},get ECullingType(){return St},get EBlendingFunction(){return J},GLTFUtils:ne,GLTFMaterialsCommonExtension:ln});class lt{constructor(){this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}get resolve(){return this._resolve}get reject(){return this._reject}}const Ws="postprocessVertexShader",Ks=`attribute vec2 position;
uniform vec2 scale;
varying vec2 vUV;
...
`;k.IncludesShadersStore[lr]=cr;const fr="pbrUboDeclaration",hr=`layout(std140,column_major) uniform;
uniform Material {
vec2 vAlbedoInfos;
vec4 vAmbientInfos;
vec2 vOpacityInfos;
...
`;k.IncludesShadersStore[fr]=hr;const ur="pbrFragmentExtraDeclaration",dr=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;k.IncludesShadersStore[ur]=dr;const _r="samplerFragmentAlternateDeclaration",Er=`#ifdef _DEFINENAME_
...
#endif
#endif
`;k.IncludesShadersStore[_r]=Er;const mr="pbrFragmentSamplersDeclaration",pr=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;k.IncludesShadersStore[mr]=pr;const Ar="subSurfaceScatteringFunctions",Tr=`bool testLightingForSSS(float diffusionProfile)
{
return diffusionProfile<1.;
}`;k.IncludesShadersStore[Ar]=Tr;const gr="importanceSampling",Rr=`vec3 hemisphereCosSample(vec2 u) {
float phi=2.*PI*u.x;
...
return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);
}`;k.IncludesShadersStore[gr]=Rr;const Cr="pbrHelperFunctions",Sr=`#define RECIPROCAL_PI2 0.15915494
...
#endif
`;k.IncludesShadersStore[Cr]=Sr;const Ir="harmonicsFunctions",vr=`#ifdef USESPHERICALFROMREFLECTIONMAP
#ifdef SPHERICAL_HARMONICS
...
#endif
#endif
`;k.IncludesShadersStore[Ir]=vr;const xr="pbrDirectLightingSetupFunctions",Mr=`struct preLightingInfo
{
vec3 lightOffset;
...
#endif
return result;
}`;k.IncludesShadersStore[xr]=Mr;const Nr="pbrDirectLightingFalloffFunctions",Or=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
{
...
#endif
}`;k.IncludesShadersStore[Nr]=Or;const yr="pbrBRDFFunctions",br=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;k.IncludesShadersStore[yr]=br;const Lr="hdrFilteringFunctions",Pr=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;k.IncludesShadersStore[Lr]=Pr;const Dr="pbrDirectLightingFunctions",Fr=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{
vec3 diffuse;
#ifdef SPECULARTERM
...
#endif
`;k.IncludesShadersStore[Dr]=Fr;const Br="pbrIBLFunctions",Ur=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;k.IncludesShadersStore[Br]=Ur;const wr="pbrBlockAlbedoOpacity",Gr=`struct albedoOpacityOutParams
{
vec3 surfaceAlbedo;
float alpha;
};
...
`;k.IncludesShadersStore[wr]=Gr;const Vr="pbrBlockReflectivity",Hr=`struct reflectivityOutParams
{
float microSurface;
float roughness;
...
`;k.IncludesShadersStore[Vr]=Hr;const kr="pbrBlockAmbientOcclusion",Xr=`struct ambientOcclusionOutParams
{
vec3 ambientOcclusionColor;
#if DEBUGMODE>0
...
`;k.IncludesShadersStore[kr]=Xr;const Yr="pbrBlockAlphaFresnel",zr=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;k.IncludesShadersStore[Yr]=zr;const Wr="pbrBlockAnisotropic",Kr=`#ifdef ANISOTROPIC
...
#endif
`;k.IncludesShadersStore[Wr]=Kr;const Qr="pbrBlockReflection",jr=`#ifdef REFLECTION
...
#endif
`;k.IncludesShadersStore[Qr]=jr;const qr="pbrBlockSheen",Zr=`#ifdef SHEEN
...
#endif
`;k.IncludesShadersStore[qr]=Zr;const Jr="pbrBlockClearcoat",$r=`struct clearcoatOutParams
{
...
#endif
`;k.IncludesShadersStore[Jr]=$r;const ea="pbrBlockIridescence",ta=`struct iridescenceOutParams
{
float iridescenceIntensity;
...
#endif
`;k.IncludesShadersStore[ea]=ta;const ia="pbrBlockSubSurface",na=`struct subSurfaceOutParams
{
...
#endif
`;k.IncludesShadersStore[ia]=na;const sa="pbrBlockNormalGeometric",ra=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;k.IncludesShadersStore[sa]=ra;const aa="pbrBlockNormalFinal",oa=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;k.IncludesShadersStore[aa]=oa;const la="pbrBlockLightmapInit",ca=`#ifdef LIGHTMAP
...
#endif
`;k.IncludesShadersStore[la]=ca;const fa="pbrBlockGeometryInfo",ha=`float NdotVUnclamped=dot(normalW,viewDirectionW);
...
#endif
#endif
`;k.IncludesShadersStore[fa]=ha;const ua="pbrBlockReflectance0",da=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);
...
#endif
`;k.IncludesShadersStore[ua]=da;const _a="pbrBlockReflectance",Ea=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;k.IncludesShadersStore[_a]=Ea;const ma="pbrBlockDirectLighting",pa=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;k.IncludesShadersStore[ma]=pa;const Aa="pbrBlockFinalLitComponents",Ta=`#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;k.IncludesShadersStore[Aa]=Ta;const ga="pbrBlockFinalUnlitComponents",Ra=`vec3 finalDiffuse=diffuseBase;
...
`;k.IncludesShadersStore[ga]=Ra;const Ca="pbrBlockFinalColorComposition",Sa=`vec4 finalColor=vec4(
finalAmbient +
finalDiffuse +
#ifndef UNLIT
#ifdef REFLECTION
...
`;k.IncludesShadersStore[Ca]=Sa;const Ia="pbrBlockImageProcessing",va=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;k.IncludesShadersStore[Ia]=va;const xa="pbrDebug",Ma=`#if DEBUGMODE>0
...
#endif
`;k.IncludesShadersStore[xa]=Ma;const Na="pbrPixelShader",Oa=`#if defined(BUMP) || !defined(NORMAL) || defined(FORCENORMALFORWARD) || defined(SPECULARAA) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
`;k.ShadersStore[Na]=Oa;const ya="pbrVertexDeclaration",ba=`uniform mat4 view;
...
`;k.IncludesShadersStore[ya]=ba;const La="pbrVertexShader",Pa=`precision highp float;
