...
`);const t={vertex:"GLTFDefaultMaterial",fragment:"GLTFDefaultMaterial"},i={attributes:["position"],uniforms:["worldView","projection","u_emission"],samplers:new Array,needAlphaBlending:!1};se._DefaultMaterial=new nn("GLTFDefaultMaterial",e,t,i),se._DefaultMaterial.setColor4("u_emission",new ss(.5,.5,.5,1))}return se._DefaultMaterial}}se._DefaultMaterial=null;var ke;(function(a){a[a.IDENTIFIER=1]="IDENTIFIER",a[a.UNKNOWN=2]="UNKNOWN",a[a.END_OF_INPUT=3]="END_OF_INPUT"})(ke||(ke={}));class Vi{constructor(e){this._pos=0,this.currentToken=ke.UNKNOWN,this.currentIdentifier="",this.currentString="",this.isLetterOrDigitPattern=/^[a-zA-Z0-9]+$/,this._toParse=e,this._maxPos=e.length}getNextToken(){if(this.isEnd())return ke.END_OF_INPUT;if(this.currentString=this.read(),this.currentToken=ke.UNKNOWN,this.currentString==="_"||this.isLetterOrDigitPattern.test(this.currentString))for(this.currentToken=ke.IDENTIFIER,this.currentIdentifier=this.currentString;!this.isEnd()&&(this.isLetterOrDigitPattern.test(this.currentString=this.peek())||this.currentString==="_");)this.currentIdentifier+=this.currentString,this.forward();return this.currentToken}peek(){return this._toParse[this._pos]}read(){return this._toParse[this._pos++]}forward(){this._pos++}isEnd(){return this._pos>=this._maxPos}}const fn=["MODEL","VIEW","PROJECTION","MODELVIEW","MODELVIEWPROJECTION","JOINTMATRIX"],hn=["world","view","projection","worldView","worldViewProjection","mBones"],Fs=["translation","rotation","scale"],Bs=["position","rotationQuaternion","scaling"],Us=(a,e)=>{for(const t in a){const i=a[t];e.buffers[t]=i,e.buffersCount++}},ws=(a,e)=>{for(const t in a){const i=a[t];e.shaders[t]=i,e.shaderscount++}},he=(a,e,t)=>{for(const i in a){const n=a[i];t[e][i]=n}},Gs=a=>{if(a)for(let e=0;e<a.length/2;e++)a[e*2+1]=1-a[e*2+1]},ki=a=>{if(a.semantic==="NORMAL")return"normal";if(a.semantic==="POSITION")return"position";if(a.semantic==="JOINT")return"matricesIndices";if(a.semantic==="WEIGHT")return"matricesWeights";if(a.semantic==="COLOR")return"color";if(a.semantic&&a.semantic.indexOf("TEXCOORD_")!==-1){const e=Number(a.semantic.split("_")[1]);return"uv"+(e===0?"":e+1)}return null},Vs=a=>{for(const e in a.animations){const t=a.animations[e];if(!t.channels||!t.samplers)continue;let i=null;for(let n=0;n<t.channels.length;n++){const s=t.channels[n],r=t.samplers[s.sampler];if(!r)continue;let o=null,l=null;t.parameters?(o=t.parameters[r.input],l=t.parameters[r.output]):(o=r.input,l=r.output);const c=se.GetBufferFromAccessor(a,a.accessors[o]),f=se.GetBufferFromAccessor(a,a.accessors[l]),h=s.target.id;let u=a.scene.getNodeById(h);if(u===null&&(u=a.scene.getNodeByName(h)),u===null){G.Warn("Creating animation named "+e+". But cannot find node named "+h+" to attach to");continue}const E=u instanceof We;let d=s.target.path;const _=Fs.indexOf(d);_!==-1&&(d=Bs[_]);let p=w.ANIMATIONTYPE_MATRIX;E||(d==="rotationQuaternion"?(p=w.ANIMATIONTYPE_QUATERNION,u.rotationQuaternion=new me):p=w.ANIMATIONTYPE_VECTOR3);let g=null;const R=[];let x=0,y=!1;E&&i&&i.getKeys().length===c.length&&(g=i,y=!0),y||(a.scene._blockEntityCollection=!!a.assetContainer,g=new w(e,E?"_matrix":d,1,p,w.ANIMATIONLOOPMODE_CYCLE),a.scene._blockEntityCollection=!1);for(let S=0;S<c.length;S++){let v=null;if(d==="rotationQuaternion"?(v=me.FromArray([f[x],f[x+1],f[x+2],f[x+3]]),x+=4):(v=A.FromArray([f[x],f[x+1],f[x+2]]),x+=3),E){const O=u;let D=A.Zero(),H=new me,Y=A.Zero(),$=O.getBaseMatrix();y&&i&&($=i.getKeys()[S].value),$.decompose(Y,H,D),d==="position"?D=v:d==="rotationQuaternion"?H=v:Y=v,v=z.Compose(Y,H,D)}y?i&&(i.getKeys()[S].value=v):R.push({frame:c[S],value:v})}!y&&g&&(g.setKeys(R),u.animations.push(g)),i=g,a.scene.stopAnimation(u),a.scene.beginAnimation(u,0,c[c.length-1],!0,1)}}},Oi=a=>{let e=null;if(a.translation||a.rotation||a.scale){const t=A.FromArray(a.scale||[1,1,1]),i=me.FromArray(a.rotation||[0,0,0,1]),n=A.FromArray(a.translation||[0,0,0]);e=z.Compose(t,i,n)}else e=z.FromArray(a.matrix);return e},un=(a,e,t,i)=>{for(let s=0;s<i.bones.length;s++)if(i.bones[s].name===t)return i.bones[s];const n=a.nodes;for(const s in n){const r=n[s];if(!r.jointName)continue;const o=r.children;for(let l=0;l<o.length;l++){const c=a.nodes[o[l]];if(c.jointName&&c.jointName===t){const f=Oi(r),h=new We(r.name||"",i,un(a,e,r.jointName,i),f);return h.id=s,h}}}return null},ks=(a,e)=>{for(let t=0;t<a.length;t++){const i=a[t];for(let n=0;n<i.node.children.length;n++)if(i.node.children[n]===e)return i.bone}return null},Gt=(a,e)=>{const t=a.nodes;let i=t[e];if(i)return{node:i,id:e};for(const n in t)if(i=t[n],i.jointName===e)return{node:i,id:n};return null},Hs=(a,e)=>{for(let t=0;t<a.jointNames.length;t++)if(a.jointNames[t]===e)return!0;return!1},Xs=(a,e,t,i)=>{for(const n in a.nodes){const s=a.nodes[n],r=n;if(!s.jointName||Hs(t,s.jointName))continue;const o=Oi(s),l=new We(s.name||"",e,null,o);l.id=r,i.push({bone:l,node:s,id:r})}for(let n=0;n<i.length;n++){const s=i[n],r=s.node.children;for(let o=0;o<r.length;o++){let l=null;for(let c=0;c<i.length;c++)if(i[c].id===r[o]){l=i[c];break}l&&(l.bone._parent=s.bone,s.bone.children.push(l.bone))}}},Ys=(a,e,t,i)=>{if(i||(i=new nt(e.name||"","",a.scene)),!e.babylonSkeleton)return i;const n=[],s=[];Xs(a,i,e,n),i.bones=[];for(let o=0;o<e.jointNames.length;o++){const l=Gt(a,e.jointNames[o]);if(!l)continue;const c=l.node;if(!c){G.Warn("Joint named "+e.jointNames[o]+" does not exist");continue}const f=l.id,h=a.scene.getBoneById(f);if(h){i.bones.push(h);continue}let u=!1,E=null;for(let p=0;p<o;p++){const g=Gt(a,e.jointNames[p]);if(!g)continue;const R=g.node;if(!R){G.Warn("Joint named "+e.jointNames[p]+" does not exist when looking for parent");continue}const x=R.children;if(x){u=!1;for(let y=0;y<x.length;y++)if(x[y]===f){E=un(a,e,e.jointNames[p],i),u=!0;break}if(u)break}}const d=Oi(c);!E&&n.length>0&&(E=ks(n,f),E&&s.indexOf(E)===-1&&s.push(E));const _=new We(c.jointName||"",i,E,d);_.id=f}const r=i.bones;i.bones=[];for(let o=0;o<e.jointNames.length;o++){const l=Gt(a,e.jointNames[o]);if(l){for(let c=0;c<r.length;c++)if(r[c].id===l.id){i.bones.push(r[c]);break}}}i.prepare();for(let o=0;o<s.length;o++)i.bones.push(s[o]);return i},Hi=(a,e,t,i,n)=>{if(n||(a.scene._blockEntityCollection=!!a.assetContainer,n=new ne(e.name||"",a.scene),n._parentContainer=a.assetContainer,a.scene._blockEntityCollection=!1,n.id=i),!e.babylonNode)return n;const s=[];let r=null;const o=new Array,l=new Array,c=new Array,f=new Array;for(let E=0;E<t.length;E++){const d=t[E],_=a.meshes[d];if(_)for(let p=0;p<_.primitives.length;p++){const g=new Yt,R=_.primitives[p];R.mode;const x=R.attributes;let y=null,S=null;for(const O in x)if(y=a.accessors[x[O]],S=se.GetBufferFromAccessor(a,y),O==="NORMAL")g.normals=new Float32Array(S.length),g.normals.set(S);else if(O==="POSITION"){if(J.HomogeneousCoordinates){g.positions=new Float32Array(S.length-S.length/4);for(let D=0;D<S.length;D+=4)g.positions[D]=S[D],g.positions[D+1]=S[D+1],g.positions[D+2]=S[D+2]}else g.positions=new Float32Array(S.length),g.positions.set(S);l.push(g.positions.length)}else if(O.indexOf("TEXCOORD_")!==-1){const D=Number(O.split("_")[1]),H=b.UVKind+(D===0?"":D+1),Y=new Float32Array(S.length);Y.set(S),Gs(Y),g.set(Y,H)}else O==="JOINT"?(g.matricesIndices=new Float32Array(S.length),g.matricesIndices.set(S)):O==="WEIGHT"?(g.matricesWeights=new Float32Array(S.length),g.matricesWeights.set(S)):O==="COLOR"&&(g.colors=new Float32Array(S.length),g.colors.set(S));if(y=a.accessors[R.indices],y)S=se.GetBufferFromAccessor(a,y),g.indices=new Int32Array(S.length),g.indices.set(S),f.push(g.indices.length);else{const O=[];for(let D=0;D<g.positions.length/3;D++)O.push(D);g.indices=new Int32Array(O),f.push(g.indices.length)}r?r.merge(g):r=g;const v=a.scene.getMaterialById(R.material);s.push(v===null?se.GetDefaultMaterial(a.scene):v),o.push(o.length===0?0:o[o.length-1]+l[l.length-2]),c.push(c.length===0?0:c[c.length-1]+f[f.length-2])}}let h;a.scene._blockEntityCollection=!!a.assetContainer,s.length>1?(h=new as("multimat"+i,a.scene),h.subMaterials=s):h=new xi("multimat"+i,a.scene),s.length===1&&(h=s[0]),h._parentContainer=a.assetContainer,n.material||(n.material=h),new Mi(i,a.scene,r,!1,n),n.computeWorldMatrix(!0),a.scene._blockEntityCollection=!1,n.subMeshes=[];let u=0;for(let E=0;E<t.length;E++){const d=t[E],_=a.meshes[d];if(_)for(let p=0;p<_.primitives.length;p++)_.primitives[p].mode,os.AddToMesh(u,o[u],l[u],c[u],f[u],n,n,!0),u++}return n},Kt=(a,e,t,i)=>{a.position&&(a.position=e),(a.rotationQuaternion||a.rotation)&&(a.rotationQuaternion=t),a.scaling&&(a.scaling=i)},zs=(a,e)=>{if(e.matrix){const t=new A(0,0,0),i=new me,n=new A(0,0,0);z.FromArray(e.matrix).decompose(n,i,t),Kt(a,t,i,n)}else e.translation&&e.rotation&&e.scale&&Kt(a,A.FromArray(e.translation),me.FromArray(e.rotation),A.FromArray(e.scale));a.computeWorldMatrix(!0)},Ws=(a,e,t)=>{let i=null;if(a.importOnlyMeshes&&(e.skin||e.meshes)&&a.importMeshesNames&&a.importMeshesNames.length>0&&a.importMeshesNames.indexOf(e.name||"")===-1)return null;if(e.skin){if(e.meshes){const n=a.skins[e.skin],s=Hi(a,e,e.meshes,t,e.babylonNode);s.skeleton=a.scene.getLastSkeletonById(e.skin),s.skeleton===null&&(s.skeleton=Ys(a,n,s,n.babylonSkeleton),n.babylonSkeleton||(n.babylonSkeleton=s.skeleton)),i=s}}else if(e.meshes)i=Hi(a,e,e.mesh?[e.mesh]:e.meshes,t,e.babylonNode);else if(e.light&&!e.babylonNode&&!a.importOnlyMeshes){const n=a.lights[e.light];if(n){if(n.type==="ambient"){const s=n[n.type],r=new sn(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=k.FromArray(s.color)),i=r}else if(n.type==="directional"){const s=n[n.type],r=new Se(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=k.FromArray(s.color)),i=r}else if(n.type==="point"){const s=n[n.type],r=new Tt(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=k.FromArray(s.color)),i=r}else if(n.type==="spot"){const s=n[n.type],r=new Ae(e.light,A.Zero(),A.Zero(),0,0,a.scene);r.name=e.name||"",s.color&&(r.diffuse=k.FromArray(s.color)),s.fallOfAngle&&(r.angle=s.fallOfAngle),s.fallOffExponent&&(r.exponent=s.fallOffExponent),i=r}}}else if(e.camera&&!e.babylonNode&&!a.importOnlyMeshes){const n=a.cameras[e.camera];if(n){if(a.scene._blockEntityCollection=!!a.assetContainer,n.type==="orthographic"){const s=new Ke(e.camera,A.Zero(),a.scene,!1);s.name=e.name||"",s.mode=Ii.ORTHOGRAPHIC_CAMERA,s.attachControl(),i=s,s._parentContainer=a.assetContainer}else if(n.type==="perspective"){const s=n[n.type],r=new Ke(e.camera,A.Zero(),a.scene,!1);r.name=e.name||"",r.attachControl(),s.aspectRatio||(s.aspectRatio=a.scene.getEngine().getRenderWidth()/a.scene.getEngine().getRenderHeight()),s.znear&&s.zfar&&(r.maxZ=s.zfar,r.minZ=s.znear),i=r,r._parentContainer=a.assetContainer}a.scene._blockEntityCollection=!1}}if(!e.jointName){if(e.babylonNode)return e.babylonNode;if(i===null){a.scene._blockEntityCollection=!!a.assetContainer;const n=new ne(e.name||"",a.scene);n._parentContainer=a.assetContainer,a.scene._blockEntityCollection=!1,e.babylonNode=n,i=n}}if(i!==null){if(e.matrix&&i instanceof ne)zs(i,e);else{const n=e.translation||[0,0,0],s=e.rotation||[0,0,0,1],r=e.scale||[1,1,1];Kt(i,A.FromArray(n),me.FromArray(s),A.FromArray(r))}i.updateCache(!0),e.babylonNode=i}return i},mt=(a,e,t,i=!1)=>{const n=a.nodes[e];let s=null;if(a.importOnlyMeshes&&!i&&a.importMeshesNames?a.importMeshesNames.indexOf(n.name||"")!==-1||a.importMeshesNames.length===0?i=!0:i=!1:i=!0,!n.jointName&&i&&(s=Ws(a,n,e),s!==null&&(s.id=e,s.parent=t)),n.children)for(let r=0;r<n.children.length;r++)mt(a,n.children[r],s,i)},Xi=a=>{let e=a.currentScene;if(e)for(let t=0;t<e.nodes.length;t++)mt(a,e.nodes[t],null);else for(const t in a.scenes){e=a.scenes[t];for(let i=0;i<e.nodes.length;i++)mt(a,e.nodes[i],null)}Vs(a);for(let t=0;t<a.scene.skeletons.length;t++){const i=a.scene.skeletons[t];a.scene.beginAnimation(i,0,Number.MAX_VALUE,!0,1)}},Ks=(a,e,t,i,n,s,r)=>{const o=s.values||n.parameters;for(const l in t){const c=t[l],f=c.type;if(f===de.FLOAT_MAT2||f===de.FLOAT_MAT3||f===de.FLOAT_MAT4){if(c.semantic&&!c.source&&!c.node)se.SetMatrix(e.scene,a,c,l,i.getEffect());else if(c.semantic&&(c.source||c.node)){let h=e.scene.getNodeByName(c.source||c.node||"");if(h===null&&(h=e.scene.getNodeById(c.source||c.node||"")),h===null)continue;se.SetMatrix(e.scene,h,c,l,i.getEffect())}}else{const h=o[n.uniforms[l]];if(!h)continue;if(f===de.SAMPLER_2D){const u=e.textures[s.values?h:c.value].babylonTexture;if(u==null)continue;i.getEffect().setTexture(l,u)}else se.SetUniform(i.getEffect(),l,h,f)}}r(i)},Qs=(a,e,t,i,n)=>{const s=i.values||t.parameters,r=t.uniforms;for(const o in n){const l=n[o],c=l.type;let f=s[r[o]];if(f===void 0&&(f=l.value),!f)continue;const h=u=>E=>{l.value&&u&&(e.setTexture(u,E),delete n[u])};c===de.SAMPLER_2D?re.LoadTextureAsync(a,i.values?f:l.value,h(o),()=>h(null)):l.value&&se.SetUniform(e,o,i.values?f:l.value,c)&&delete n[o]}},js=(a,e,t)=>(i,n)=>{e.dispose(!0),t("Cannot compile program named "+a.name+". Error: "+n+". Default material will be applied")},qs=(a,e,t,i,n,s)=>r=>{Qs(a,e,t,i,n),e.onBind=o=>{Ks(o,a,n,e,t,i,s)}},Yi=(a,e,t)=>{for(const i in e.uniforms){const n=e.uniforms[i],s=e.parameters[n];if(a.currentIdentifier===i&&s.semantic&&!s.source&&!s.node){const r=fn.indexOf(s.semantic);if(r!==-1)return delete t[i],hn[r]}}return a.currentIdentifier},zi=a=>{for(const e in a.materials)re.LoadMaterialAsync(a,e,()=>{},()=>{})};class Ne{static CreateRuntime(e,t,i){const n={extensions:{},accessors:{},buffers:{},bufferViews:{},meshes:{},lights:{},cameras:{},nodes:{},images:{},textures:{},shaders:{},programs:{},samplers:{},techniques:{},materials:{},animations:{},skins:{},extensionsUsed:[],scenes:{},buffersCount:0,shaderscount:0,scene:t,rootUrl:i,loadedBufferCount:0,loadedBufferViews:{},loadedShaderCount:0,importOnlyMeshes:!1,dummyNodes:[],assetContainer:null};return e.extensions&&he(e.extensions,"extensions",n),e.extensionsUsed&&he(e.extensionsUsed,"extensionsUsed",n),e.buffers&&Us(e.buffers,n),e.bufferViews&&he(e.bufferViews,"bufferViews",n),e.accessors&&he(e.accessors,"accessors",n),e.meshes&&he(e.meshes,"meshes",n),e.lights&&he(e.lights,"lights",n),e.cameras&&he(e.cameras,"cameras",n),e.nodes&&he(e.nodes,"nodes",n),e.images&&he(e.images,"images",n),e.textures&&he(e.textures,"textures",n),e.shaders&&ws(e.shaders,n),e.programs&&he(e.programs,"programs",n),e.samplers&&he(e.samplers,"samplers",n),e.techniques&&he(e.techniques,"techniques",n),e.materials&&he(e.materials,"materials",n),e.animations&&he(e.animations,"animations",n),e.skins&&he(e.skins,"skins",n),e.scenes&&(n.scenes=e.scenes),e.scene&&e.scenes&&(n.currentScene=e.scenes[e.scene]),n}static LoadBufferAsync(e,t,i,n,s){const r=e.buffers[t];G.IsBase64(r.uri)?setTimeout(()=>i(new Uint8Array(G.DecodeBase64(r.uri)))):G.LoadFile(e.rootUrl+r.uri,o=>i(new Uint8Array(o)),s,void 0,!0,o=>{o&&n(o.status+" "+o.statusText)})}static LoadTextureBufferAsync(e,t,i,n){const s=e.textures[t];if(!s||!s.source){n("");return}if(s.babylonTexture){i(null);return}const r=e.images[s.source];G.IsBase64(r.uri)?setTimeout(()=>i(new Uint8Array(G.DecodeBase64(r.uri)))):G.LoadFile(e.rootUrl+r.uri,o=>i(new Uint8Array(o)),void 0,void 0,!0,o=>{o&&n(o.status+" "+o.statusText)})}static CreateTextureAsync(e,t,i,n){const s=e.textures[t];if(s.babylonTexture){n(s.babylonTexture);return}const r=e.samplers[s.sampler],o=r.minFilter===Ce.NEAREST_MIPMAP_NEAREST||r.minFilter===Ce.NEAREST_MIPMAP_LINEAR||r.minFilter===Ce.LINEAR_MIPMAP_NEAREST||r.minFilter===Ce.LINEAR_MIPMAP_LINEAR,l=U.BILINEAR_SAMPLINGMODE,c=i==null?new Blob:new Blob([i]),f=URL.createObjectURL(c),h=()=>URL.revokeObjectURL(f),u=new U(f,e.scene,!o,!0,l,h,h);r.wrapS!==void 0&&(u.wrapU=se.GetWrapMode(r.wrapS)),r.wrapT!==void 0&&(u.wrapV=se.GetWrapMode(r.wrapT)),u.name=t,s.babylonTexture=u,n(u)}static LoadShaderStringAsync(e,t,i,n){const s=e.shaders[t];if(G.IsBase64(s.uri)){const r=atob(s.uri.split(",")[1]);i&&i(r)}else G.LoadFile(e.rootUrl+s.uri,i,void 0,void 0,!1,r=>{r&&n&&n(r.status+" "+r.statusText)})}static LoadMaterialAsync(e,t,i,n){const s=e.materials[t];if(!s.technique){n&&n("No technique found.");return}const r=e.techniques[s.technique];if(!r){e.scene._blockEntityCollection=!!e.assetContainer;const v=new xi(t,e.scene);v._parentContainer=e.assetContainer,e.scene._blockEntityCollection=!1,v.diffuseColor=new k(.5,.5,.5),v.sideOrientation=oe.CounterClockWiseSideOrientation,i(v);return}const o=e.programs[r.program],l=r.states,c=Ve.ShadersStore[o.vertexShader+"VertexShader"],f=Ve.ShadersStore[o.fragmentShader+"PixelShader"];let h="",u="";const E=new Vi(c),d=new Vi(f),_={},p=[],g=[],R=[];for(const v in r.uniforms){const O=r.uniforms[v],D=r.parameters[O];if(_[v]=D,D.semantic&&!D.node&&!D.source){const H=fn.indexOf(D.semantic);H!==-1?(p.push(hn[H]),delete _[v]):p.push(v)}else D.type===de.SAMPLER_2D?R.push(v):p.push(v)}for(const v in r.attributes){const O=r.attributes[v],D=r.parameters[O];if(D.semantic){const H=ki(D);H&&g.push(H)}}for(;!E.isEnd()&&E.getNextToken();){if(E.currentToken!==ke.IDENTIFIER){h+=E.currentString;continue}let O=!1;for(const D in r.attributes){const H=r.attributes[D],Y=r.parameters[H];if(E.currentIdentifier===D&&Y.semantic){h+=ki(Y),O=!0;break}}O||(h+=Yi(E,r,_))}for(;!d.isEnd()&&d.getNextToken();){if(d.currentToken!==ke.IDENTIFIER){u+=d.currentString;continue}u+=Yi(d,r,_)}const x={vertex:o.vertexShader+t,fragment:o.fragmentShader+t},y={attributes:g,uniforms:p,samplers:R,needAlphaBlending:l&&l.enable&&l.enable.indexOf(3042)!==-1};Ve.ShadersStore[o.vertexShader+t+"VertexShader"]=h,Ve.ShadersStore[o.fragmentShader+t+"PixelShader"]=u;const S=new nn(t,e.scene,x,y);if(S.onError=js(o,S,n),S.onCompiled=qs(e,S,r,s,_,i),S.sideOrientation=oe.CounterClockWiseSideOrientation,l&&l.functions){const v=l.functions;v.cullFace&&v.cullFace[0]!==vt.BACK&&(S.backFaceCulling=!1);const O=v.blendFuncSeparate;O&&(O[0]===ee.SRC_ALPHA&&O[1]===ee.ONE_MINUS_SRC_ALPHA&&O[2]===ee.ONE&&O[3]===ee.ONE?S.alphaMode=Xe.ALPHA_COMBINE:O[0]===ee.ONE&&O[1]===ee.ONE&&O[2]===ee.ZERO&&O[3]===ee.ONE?S.alphaMode=Xe.ALPHA_ONEONE:O[0]===ee.SRC_ALPHA&&O[1]===ee.ONE&&O[2]===ee.ZERO&&O[3]===ee.ONE?S.alphaMode=Xe.ALPHA_ADD:O[0]===ee.ZERO&&O[1]===ee.ONE_MINUS_SRC_COLOR&&O[2]===ee.ONE&&O[3]===ee.ONE?S.alphaMode=Xe.ALPHA_SUBTRACT:O[0]===ee.DST_COLOR&&O[1]===ee.ZERO&&O[2]===ee.ONE&&O[3]===ee.ONE?S.alphaMode=Xe.ALPHA_MULTIPLY:O[0]===ee.SRC_ALPHA&&O[1]===ee.ONE_MINUS_SRC_COLOR&&O[2]===ee.ONE&&O[3]===ee.ONE&&(S.alphaMode=Xe.ALPHA_MAXIMIZED))}}}let Qe=class Qt{static RegisterExtension(e){if(Qt.Extensions[e.name]){G.Error('Tool with the same name "'+e.name+'" already exists');return}Qt.Extensions[e.name]=e}dispose(){}_importMeshAsync(e,t,i,n,s,r,o,l){return t.useRightHandedSystem=!0,re.LoadRuntimeAsync(t,i,n,c=>{c.assetContainer=s,c.importOnlyMeshes=!0,e===""?c.importMeshesNames=[]:typeof e=="string"?c.importMeshesNames=[e]:e&&!(e instanceof Array)?c.importMeshesNames=[e]:(c.importMeshesNames=[],G.Warn("Argument meshesNames must be of type string or string[]")),this._createNodes(c);const f=new Array,h=new Array;for(const u in c.nodes){const E=c.nodes[u];E.babylonNode instanceof rs&&f.push(E.babylonNode)}for(const u in c.skins){const E=c.skins[u];E.babylonSkeleton instanceof nt&&h.push(E.babylonSkeleton)}this._loadBuffersAsync(c,()=>{this._loadShadersAsync(c,()=>{zi(c),Xi(c),!J.IncrementalLoading&&r&&r(f,h)})}),J.IncrementalLoading&&r&&r(f,h)},l),!0}importMeshAsync(e,t,i,n,s,r){return new Promise((o,l)=>{this._importMeshAsync(e,t,n,s,i,(c,f)=>{o({meshes:c,particleSystems:[],skeletons:f,animationGroups:[],lights:[],transformNodes:[],geometries:[]})},r,c=>{l(new Error(c))})})}_loadAsync(e,t,i,n,s,r){e.useRightHandedSystem=!0,re.LoadRuntimeAsync(e,t,i,o=>{re.LoadRuntimeExtensionsAsync(o,()=>{this._createNodes(o),this._loadBuffersAsync(o,()=>{this._loadShadersAsync(o,()=>{zi(o),Xi(o),J.IncrementalLoading||n()})}),J.IncrementalLoading&&n()},r)},r)}loadAsync(e,t,i,n){return new Promise((s,r)=>{this._loadAsync(e,t,i,()=>{s()},n,o=>{r(new Error(o))})})}_loadShadersAsync(e,t){let i=!1;const n=(s,r)=>{re.LoadShaderStringAsync(e,s,o=>{o instanceof ArrayBuffer||(e.loadedShaderCount++,o&&(Ve.ShadersStore[s+(r.type===It.VERTEX?"VertexShader":"PixelShader")]=o),e.loadedShaderCount===e.shaderscount&&t())},()=>{G.Error("Error when loading shader program named "+s+" located at "+r.uri)})};for(const s in e.shaders){i=!0;const r=e.shaders[s];r?n.bind(this,s,r)():G.Error("No shader named: "+s)}i||t()}_loadBuffersAsync(e,t){let i=!1;const n=(s,r)=>{re.LoadBufferAsync(e,s,o=>{e.loadedBufferCount++,o&&(o.byteLength!=e.buffers[s].byteLength&&G.Error("Buffer named "+s+" is length "+o.byteLength+". Expected: "+r.byteLength),e.loadedBufferViews[s]=o),e.loadedBufferCount===e.buffersCount&&t()},()=>{G.Error("Error when loading buffer named "+s+" located at "+r.uri)})};for(const s in e.buffers){i=!0;const r=e.buffers[s];r?n.bind(this,s,r)():G.Error("No buffer named: "+s)}i||t()}_createNodes(e){let t=e.currentScene;if(t)for(let i=0;i<t.nodes.length;i++)mt(e,t.nodes[i],null);else for(const i in e.scenes){t=e.scenes[i];for(let n=0;n<t.nodes.length;n++)mt(e,t.nodes[n],null)}}};Qe.Extensions={};class re{constructor(e){this._name=e}get name(){return this._name}loadRuntimeAsync(e,t,i,n,s){return!1}loadRuntimeExtensionsAsync(e,t,i){return!1}loadBufferAsync(e,t,i,n,s){return!1}loadTextureBufferAsync(e,t,i,n){return!1}createTextureAsync(e,t,i,n,s){return!1}loadShaderStringAsync(e,t,i,n){return!1}loadMaterialAsync(e,t,i,n){return!1}static LoadRuntimeAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.loadRuntimeAsync(e,t,i,n,s),()=>{setTimeout(()=>{n&&n(Ne.CreateRuntime(t.json,e,i))})})}static LoadRuntimeExtensionsAsync(e,t,i){re._ApplyExtensions(n=>n.loadRuntimeExtensionsAsync(e,t,i),()=>{setTimeout(()=>{t()})})}static LoadBufferAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.loadBufferAsync(e,t,i,n,s),()=>{Ne.LoadBufferAsync(e,t,i,n,s)})}static LoadTextureAsync(e,t,i,n){re._LoadTextureBufferAsync(e,t,s=>{s&&re._CreateTextureAsync(e,t,s,i,n)},n)}static LoadShaderStringAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadShaderStringAsync(e,t,i,n),()=>{Ne.LoadShaderStringAsync(e,t,i,n)})}static LoadMaterialAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadMaterialAsync(e,t,i,n),()=>{Ne.LoadMaterialAsync(e,t,i,n)})}static _LoadTextureBufferAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadTextureBufferAsync(e,t,i,n),()=>{Ne.LoadTextureBufferAsync(e,t,i,n)})}static _CreateTextureAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.createTextureAsync(e,t,i,n,s),()=>{Ne.CreateTextureAsync(e,t,i,n)})}static _ApplyExtensions(e,t){for(const i in Qe.Extensions){const n=Qe.Extensions[i];if(e(n))return}t()}}J._CreateGLTF1Loader=()=>new Qe;const Zs="binary_glTF";class dn extends re{constructor(){super("KHR_binary_glTF")}loadRuntimeAsync(e,t,i,n){const s=t.json.extensionsUsed;return!s||s.indexOf(this.name)===-1||!t.bin?!1:(this._bin=t.bin,n(Ne.CreateRuntime(t.json,e,i)),!0)}loadBufferAsync(e,t,i,n){return e.extensionsUsed.indexOf(this.name)===-1||t!==Zs?!1:(this._bin.readAsync(0,this._bin.byteLength).then(i,s=>n(s.message)),!0)}loadTextureBufferAsync(e,t,i){const n=e.textures[t],s=e.images[n.source];if(!s.extensions||!(this.name in s.extensions))return!1;const r=s.extensions[this.name],o=e.bufferViews[r.bufferView],l=se.GetBufferFromBufferView(e,o,0,o.byteLength,we.UNSIGNED_BYTE);return i(l),!0}loadShaderStringAsync(e,t,i){const n=e.shaders[t];if(!n.extensions||!(this.name in n.extensions))return!1;const s=n.extensions[this.name],r=e.bufferViews[s.bufferView],o=se.GetBufferFromBufferView(e,r,0,r.byteLength,we.UNSIGNED_BYTE);return setTimeout(()=>{const l=se.DecodeBufferToText(o);i(l)}),!0}}Qe.RegisterExtension(new dn);class _n extends re{constructor(){super("KHR_materials_common")}loadRuntimeExtensionsAsync(e){if(!e.extensions)return!1;const t=e.extensions[this.name];if(!t)return!1;const i=t.lights;if(i)for(const n in i){const s=i[n];switch(s.type){case"ambient":{const r=new sn(s.name,new A(0,1,0),e.scene),o=s.ambient;o&&(r.diffuse=k.FromArray(o.color||[1,1,1]));break}case"point":{const r=new Tt(s.name,new A(10,10,10),e.scene),o=s.point;o&&(r.diffuse=k.FromArray(o.color||[1,1,1]));break}case"directional":{const r=new Se(s.name,new A(0,-1,0),e.scene),o=s.directional;o&&(r.diffuse=k.FromArray(o.color||[1,1,1]));break}case"spot":{const r=s.spot;if(r){const o=new Ae(s.name,new A(0,10,0),new A(0,-1,0),r.fallOffAngle||Math.PI,r.fallOffExponent||0,e.scene);o.diffuse=k.FromArray(r.color||[1,1,1])}break}default:G.Warn('GLTF Material Common extension: light type "'+s.type+"” not supported");break}}return!1}loadMaterialAsync(e,t,i,n){const s=e.materials[t];if(!s||!s.extensions)return!1;const r=s.extensions[this.name];if(!r)return!1;const o=new xi(t,e.scene);return o.sideOrientation=oe.CounterClockWiseSideOrientation,r.technique==="CONSTANT"&&(o.disableLighting=!0),o.backFaceCulling=r.doubleSided===void 0?!1:!r.doubleSided,o.alpha=r.values.transparency===void 0?1:r.values.transparency,o.specularPower=r.values.shininess===void 0?0:r.values.shininess,typeof r.values.ambient=="string"?this._loadTexture(e,r.values.ambient,o,"ambientTexture",n):o.ambientColor=k.FromArray(r.values.ambient||[0,0,0]),typeof r.values.diffuse=="string"?this._loadTexture(e,r.values.diffuse,o,"diffuseTexture",n):o.diffuseColor=k.FromArray(r.values.diffuse||[0,0,0]),typeof r.values.emission=="string"?this._loadTexture(e,r.values.emission,o,"emissiveTexture",n):o.emissiveColor=k.FromArray(r.values.emission||[0,0,0]),typeof r.values.specular=="string"?this._loadTexture(e,r.values.specular,o,"specularTexture",n):o.specularColor=k.FromArray(r.values.specular||[0,0,0]),!0}_loadTexture(e,t,i,n,s){Ne.LoadTextureBufferAsync(e,t,r=>{Ne.CreateTextureAsync(e,t,r,o=>i[n]=o)},s)}}Qe.RegisterExtension(new _n);const _o=Object.freeze(Object.defineProperty({__proto__:null,get EBlendingFunction(){return ee},get EComponentType(){return we},get ECullingType(){return vt},get EParameterType(){return de},get EShaderType(){return It},get ETextureFilterType(){return Ce},get ETextureFormat(){return Wt},get ETextureWrapMode(){return tt},GLTFBinaryExtension:dn,GLTFLoader:Qe,GLTFLoaderBase:Ne,GLTFLoaderExtension:re,GLTFMaterialsCommonExtension:_n,GLTFUtils:se},Symbol.toStringTag,{value:"Module"}));class ut{get resolve(){return this._resolve}get reject(){return this._reject}constructor(){this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}}const Js="postprocessVertexShader",$s=`attribute vec2 position;
uniform vec2 scale;
varying vec2 vUV;
...
`;X.IncludesShadersStore[_r]=Er;const mr="pbrUboDeclaration",pr=`layout(std140,column_major) uniform;
uniform Material {
vec2 vAlbedoInfos;
vec4 vAmbientInfos;
vec2 vOpacityInfos;
...
`;X.IncludesShadersStore[mr]=pr;const Ar="pbrFragmentExtraDeclaration",Tr=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;X.IncludesShadersStore[Ar]=Tr;const gr="samplerFragmentAlternateDeclaration",Rr=`#ifdef _DEFINENAME_
...
#endif
#endif
`;X.IncludesShadersStore[gr]=Rr;const Cr="pbrFragmentSamplersDeclaration",Sr=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;X.IncludesShadersStore[Cr]=Sr;const Ir="subSurfaceScatteringFunctions",vr=`bool testLightingForSSS(float diffusionProfile)
{
return diffusionProfile<1.;
}`;X.IncludesShadersStore[Ir]=vr;const xr="importanceSampling",Mr=`vec3 hemisphereCosSample(vec2 u) {
float phi=2.*PI*u.x;
...
return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);
}`;X.IncludesShadersStore[xr]=Mr;const Nr="pbrHelperFunctions",Or=`#define RECIPROCAL_PI2 0.15915494
...
#endif
`;X.IncludesShadersStore[Nr]=Or;const yr="harmonicsFunctions",br=`#ifdef USESPHERICALFROMREFLECTIONMAP
#ifdef SPHERICAL_HARMONICS
...
#endif
#endif
`;X.IncludesShadersStore[yr]=br;const Lr="pbrDirectLightingSetupFunctions",Pr=`struct preLightingInfo
{
vec3 lightOffset;
...
#endif
return result;
}`;X.IncludesShadersStore[Lr]=Pr;const Dr="pbrDirectLightingFalloffFunctions",Fr=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
{
...
#endif
}`;X.IncludesShadersStore[Dr]=Fr;const Br="pbrBRDFFunctions",Ur=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;X.IncludesShadersStore[Br]=Ur;const wr="hdrFilteringFunctions",Gr=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;X.IncludesShadersStore[wr]=Gr;const Vr="pbrDirectLightingFunctions",kr=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{
vec3 diffuse;
#ifdef SPECULARTERM
...
#endif
`;X.IncludesShadersStore[Vr]=kr;const Hr="pbrIBLFunctions",Xr=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;X.IncludesShadersStore[Hr]=Xr;const Yr="pbrBlockAlbedoOpacity",zr=`struct albedoOpacityOutParams
{
vec3 surfaceAlbedo;
float alpha;
};
...
`;X.IncludesShadersStore[Yr]=zr;const Wr="pbrBlockReflectivity",Kr=`struct reflectivityOutParams
{
float microSurface;
float roughness;
...
`;X.IncludesShadersStore[Wr]=Kr;const Qr="pbrBlockAmbientOcclusion",jr=`struct ambientOcclusionOutParams
{
vec3 ambientOcclusionColor;
#if DEBUGMODE>0
...
`;X.IncludesShadersStore[Qr]=jr;const qr="pbrBlockAlphaFresnel",Zr=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;X.IncludesShadersStore[qr]=Zr;const Jr="pbrBlockAnisotropic",$r=`#ifdef ANISOTROPIC
...
#endif
`;X.IncludesShadersStore[Jr]=$r;const ea="pbrBlockReflection",ta=`#ifdef REFLECTION
...
#endif
`;X.IncludesShadersStore[ea]=ta;const ia="pbrBlockSheen",na=`#ifdef SHEEN
...
#endif
`;X.IncludesShadersStore[ia]=na;const sa="pbrBlockClearcoat",ra=`struct clearcoatOutParams
{
...
#endif
`;X.IncludesShadersStore[sa]=ra;const aa="pbrBlockIridescence",oa=`struct iridescenceOutParams
{
float iridescenceIntensity;
...
#endif
`;X.IncludesShadersStore[aa]=oa;const la="pbrBlockSubSurface",ca=`struct subSurfaceOutParams
{
...
#endif
`;X.IncludesShadersStore[la]=ca;const fa="pbrBlockNormalGeometric",ha=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;X.IncludesShadersStore[fa]=ha;const ua="pbrBlockNormalFinal",da=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;X.IncludesShadersStore[ua]=da;const _a="pbrBlockLightmapInit",Ea=`#ifdef LIGHTMAP
...
#endif
`;X.IncludesShadersStore[_a]=Ea;const ma="pbrBlockGeometryInfo",pa=`float NdotVUnclamped=dot(normalW,viewDirectionW);
...
#endif
#endif
`;X.IncludesShadersStore[ma]=pa;const Aa="pbrBlockReflectance0",Ta=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);
...
#endif
`;X.IncludesShadersStore[Aa]=Ta;const ga="pbrBlockReflectance",Ra=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;X.IncludesShadersStore[ga]=Ra;const Ca="pbrBlockDirectLighting",Sa=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;X.IncludesShadersStore[Ca]=Sa;const Ia="pbrBlockFinalLitComponents",va=`#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;X.IncludesShadersStore[Ia]=va;const xa="pbrBlockFinalUnlitComponents",Ma=`vec3 finalDiffuse=diffuseBase;
...
`;X.IncludesShadersStore[xa]=Ma;const Na="pbrBlockFinalColorComposition",Oa=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;X.IncludesShadersStore[Na]=Oa;const ya="pbrBlockImageProcessing",ba=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;X.IncludesShadersStore[ya]=ba;const La="pbrDebug",Pa=`#if DEBUGMODE>0
...
#endif
`;X.IncludesShadersStore[La]=Pa;const Da="pbrPixelShader",Fa=`#if defined(BUMP) || !defined(NORMAL) || defined(FORCENORMALFORWARD) || defined(SPECULARAA) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
`;X.ShadersStore[Da]=Fa;const Ba="pbrVertexDeclaration",Ua=`uniform mat4 view;
...
`;X.IncludesShadersStore[Ba]=Ua;const wa="pbrVertexShader",Ga=`precision highp float;
