...
`);const t={vertex:"GLTFDefaultMaterial",fragment:"GLTFDefaultMaterial"},i={attributes:["position"],uniforms:["worldView","projection","u_emission"],samplers:new Array,needAlphaBlending:!1};ne._DefaultMaterial=new Ji("GLTFDefaultMaterial",e,t,i),ne._DefaultMaterial.setColor4("u_emission",new Jn(.5,.5,.5,1))}return ne._DefaultMaterial}}ne._DefaultMaterial=null;var He;(function(a){a[a.IDENTIFIER=1]="IDENTIFIER",a[a.UNKNOWN=2]="UNKNOWN",a[a.END_OF_INPUT=3]="END_OF_INPUT"})(He||(He={}));class Bi{constructor(e){this._pos=0,this.currentToken=He.UNKNOWN,this.currentIdentifier="",this.currentString="",this.isLetterOrDigitPattern=/^[a-zA-Z0-9]+$/,this._toParse=e,this._maxPos=e.length}getNextToken(){if(this.isEnd())return He.END_OF_INPUT;if(this.currentString=this.read(),this.currentToken=He.UNKNOWN,this.currentString==="_"||this.isLetterOrDigitPattern.test(this.currentString))for(this.currentToken=He.IDENTIFIER,this.currentIdentifier=this.currentString;!this.isEnd()&&(this.isLetterOrDigitPattern.test(this.currentString=this.peek())||this.currentString==="_");)this.currentIdentifier+=this.currentString,this.forward();return this.currentToken}peek(){return this._toParse[this._pos]}read(){return this._toParse[this._pos++]}forward(){this._pos++}isEnd(){return this._pos>=this._maxPos}}const rn=["MODEL","VIEW","PROJECTION","MODELVIEW","MODELVIEWPROJECTION","JOINTMATRIX"],an=["world","view","projection","worldView","worldViewProjection","mBones"],bs=["translation","rotation","scale"],Ls=["position","rotationQuaternion","scaling"],Ps=(a,e)=>{for(const t in a){const i=a[t];e.buffers[t]=i,e.buffersCount++}},Ds=(a,e)=>{for(const t in a){const i=a[t];e.shaders[t]=i,e.shaderscount++}},fe=(a,e,t)=>{for(const i in a){const n=a[i];t[e][i]=n}},Fs=a=>{if(!!a)for(let e=0;e<a.length/2;e++)a[e*2+1]=1-a[e*2+1]},Ui=a=>{if(a.semantic==="NORMAL")return"normal";if(a.semantic==="POSITION")return"position";if(a.semantic==="JOINT")return"matricesIndices";if(a.semantic==="WEIGHT")return"matricesWeights";if(a.semantic==="COLOR")return"color";if(a.semantic&&a.semantic.indexOf("TEXCOORD_")!==-1){const e=Number(a.semantic.split("_")[1]);return"uv"+(e===0?"":e+1)}return null},Bs=a=>{for(const e in a.animations){const t=a.animations[e];if(!t.channels||!t.samplers)continue;let i=null;for(let n=0;n<t.channels.length;n++){const s=t.channels[n],r=t.samplers[s.sampler];if(!r)continue;let o=null,l=null;t.parameters?(o=t.parameters[r.input],l=t.parameters[r.output]):(o=r.input,l=r.output);const c=ne.GetBufferFromAccessor(a,a.accessors[o]),f=ne.GetBufferFromAccessor(a,a.accessors[l]),h=s.target.id;let u=a.scene.getNodeById(h);if(u===null&&(u=a.scene.getNodeByName(h)),u===null){w.Warn("Creating animation named "+e+". But cannot find node named "+h+" to attach to");continue}const _=u instanceof ze;let d=s.target.path;const E=bs.indexOf(d);E!==-1&&(d=Ls[E]);let p=U.ANIMATIONTYPE_MATRIX;_||(d==="rotationQuaternion"?(p=U.ANIMATIONTYPE_QUATERNION,u.rotationQuaternion=new Ee):p=U.ANIMATIONTYPE_VECTOR3);let g=null;const R=[];let M=0,y=!1;_&&i&&i.getKeys().length===c.length&&(g=i,y=!0),y||(a.scene._blockEntityCollection=!!a.assetContainer,g=new U(e,_?"_matrix":d,1,p,U.ANIMATIONLOOPMODE_CYCLE),a.scene._blockEntityCollection=!1);for(let N=0;N<c.length;N++){let I=null;if(d==="rotationQuaternion"?(I=Ee.FromArray([f[M],f[M+1],f[M+2],f[M+3]]),M+=4):(I=A.FromArray([f[M],f[M+1],f[M+2]]),M+=3),_){const O=u;let G=A.Zero(),Q=new Ee,X=A.Zero(),ie=O.getBaseMatrix();y&&i&&(ie=i.getKeys()[N].value),ie.decompose(X,Q,G),d==="position"?G=I:d==="rotationQuaternion"?Q=I:X=I,I=Y.Compose(X,Q,G)}y?i&&(i.getKeys()[N].value=I):R.push({frame:c[N],value:I})}!y&&g&&(g.setKeys(R),u.animations.push(g)),i=g,a.scene.stopAnimation(u),a.scene.beginAnimation(u,0,c[c.length-1],!0,1)}}},Ii=a=>{let e=null;if(a.translation||a.rotation||a.scale){const t=A.FromArray(a.scale||[1,1,1]),i=Ee.FromArray(a.rotation||[0,0,0,1]),n=A.FromArray(a.translation||[0,0,0]);e=Y.Compose(t,i,n)}else e=Y.FromArray(a.matrix);return e},on=(a,e,t,i)=>{for(let s=0;s<i.bones.length;s++)if(i.bones[s].name===t)return i.bones[s];const n=a.nodes;for(const s in n){const r=n[s];if(!r.jointName)continue;const o=r.children;for(let l=0;l<o.length;l++){const c=a.nodes[o[l]];if(!!c.jointName&&c.jointName===t){const f=Ii(r),h=new ze(r.name||"",i,on(a,e,r.jointName,i),f);return h.id=s,h}}}return null},Us=(a,e)=>{for(let t=0;t<a.length;t++){const i=a[t];for(let n=0;n<i.node.children.length;n++)if(i.node.children[n]===e)return i.bone}return null},wt=(a,e)=>{const t=a.nodes;let i=t[e];if(i)return{node:i,id:e};for(const n in t)if(i=t[n],i.jointName===e)return{node:i,id:n};return null},ws=(a,e)=>{for(let t=0;t<a.jointNames.length;t++)if(a.jointNames[t]===e)return!0;return!1},Gs=(a,e,t,i)=>{for(const n in a.nodes){const s=a.nodes[n],r=n;if(!s.jointName||ws(t,s.jointName))continue;const o=Ii(s),l=new ze(s.name||"",e,null,o);l.id=r,i.push({bone:l,node:s,id:r})}for(let n=0;n<i.length;n++){const s=i[n],r=s.node.children;for(let o=0;o<r.length;o++){let l=null;for(let c=0;c<i.length;c++)if(i[c].id===r[o]){l=i[c];break}l&&(l.bone._parent=s.bone,s.bone.children.push(l.bone))}}},Vs=(a,e,t,i)=>{if(i||(i=new nt(e.name||"","",a.scene)),!e.babylonSkeleton)return i;const n=[],s=[];Gs(a,i,e,n),i.bones=[];for(let o=0;o<e.jointNames.length;o++){const l=wt(a,e.jointNames[o]);if(!l)continue;const c=l.node;if(!c){w.Warn("Joint named "+e.jointNames[o]+" does not exist");continue}const f=l.id,h=a.scene.getBoneById(f);if(h){i.bones.push(h);continue}let u=!1,_=null;for(let p=0;p<o;p++){const g=wt(a,e.jointNames[p]);if(!g)continue;const R=g.node;if(!R){w.Warn("Joint named "+e.jointNames[p]+" does not exist when looking for parent");continue}const M=R.children;if(!!M){u=!1;for(let y=0;y<M.length;y++)if(M[y]===f){_=on(a,e,e.jointNames[p],i),u=!0;break}if(u)break}}const d=Ii(c);!_&&n.length>0&&(_=Us(n,f),_&&s.indexOf(_)===-1&&s.push(_));const E=new ze(c.jointName||"",i,_,d);E.id=f}const r=i.bones;i.bones=[];for(let o=0;o<e.jointNames.length;o++){const l=wt(a,e.jointNames[o]);if(!!l){for(let c=0;c<r.length;c++)if(r[c].id===l.id){i.bones.push(r[c]);break}}}i.prepare();for(let o=0;o<s.length;o++)i.bones.push(s[o]);return i},wi=(a,e,t,i,n)=>{if(n||(a.scene._blockEntityCollection=!!a.assetContainer,n=new se(e.name||"",a.scene),n._parentContainer=a.assetContainer,a.scene._blockEntityCollection=!1,n.id=i),!e.babylonNode)return n;const s=[];let r=null;const o=new Array,l=new Array,c=new Array,f=new Array;for(let _=0;_<t.length;_++){const d=t[_],E=a.meshes[d];if(!!E)for(let p=0;p<E.primitives.length;p++){const g=new kt,R=E.primitives[p];R.mode;const M=R.attributes;let y=null,N=null;for(const O in M)if(y=a.accessors[M[O]],N=ne.GetBufferFromAccessor(a,y),O==="NORMAL")g.normals=new Float32Array(N.length),g.normals.set(N);else if(O==="POSITION"){if(Z.HomogeneousCoordinates){g.positions=new Float32Array(N.length-N.length/4);for(let G=0;G<N.length;G+=4)g.positions[G]=N[G],g.positions[G+1]=N[G+1],g.positions[G+2]=N[G+2]}else g.positions=new Float32Array(N.length),g.positions.set(N);l.push(g.positions.length)}else if(O.indexOf("TEXCOORD_")!==-1){const G=Number(O.split("_")[1]),Q=b.UVKind+(G===0?"":G+1),X=new Float32Array(N.length);X.set(N),Fs(X),g.set(X,Q)}else O==="JOINT"?(g.matricesIndices=new Float32Array(N.length),g.matricesIndices.set(N)):O==="WEIGHT"?(g.matricesWeights=new Float32Array(N.length),g.matricesWeights.set(N)):O==="COLOR"&&(g.colors=new Float32Array(N.length),g.colors.set(N));if(y=a.accessors[R.indices],y)N=ne.GetBufferFromAccessor(a,y),g.indices=new Int32Array(N.length),g.indices.set(N),f.push(g.indices.length);else{const O=[];for(let G=0;G<g.positions.length/3;G++)O.push(G);g.indices=new Int32Array(O),f.push(g.indices.length)}r?r.merge(g):r=g;const I=a.scene.getMaterialById(R.material);s.push(I===null?ne.GetDefaultMaterial(a.scene):I),o.push(o.length===0?0:o[o.length-1]+l[l.length-2]),c.push(c.length===0?0:c[c.length-1]+f[f.length-2])}}let h;a.scene._blockEntityCollection=!!a.assetContainer,s.length>1?(h=new es("multimat"+i,a.scene),h.subMaterials=s):h=new Ri("multimat"+i,a.scene),s.length===1&&(h=s[0]),h._parentContainer=a.assetContainer,n.material||(n.material=h),new Ci(i,a.scene,r,!1,n),n.computeWorldMatrix(!0),a.scene._blockEntityCollection=!1,n.subMeshes=[];let u=0;for(let _=0;_<t.length;_++){const d=t[_],E=a.meshes[d];if(!!E)for(let p=0;p<E.primitives.length;p++)E.primitives[p].mode,ts.AddToMesh(u,o[u],l[u],c[u],f[u],n,n,!0),u++}return n},zt=(a,e,t,i)=>{a.position&&(a.position=e),(a.rotationQuaternion||a.rotation)&&(a.rotationQuaternion=t),a.scaling&&(a.scaling=i)},Hs=(a,e)=>{if(e.matrix){const t=new A(0,0,0),i=new Ee,n=new A(0,0,0);Y.FromArray(e.matrix).decompose(n,i,t),zt(a,t,i,n)}else e.translation&&e.rotation&&e.scale&&zt(a,A.FromArray(e.translation),Ee.FromArray(e.rotation),A.FromArray(e.scale));a.computeWorldMatrix(!0)},ks=(a,e,t)=>{let i=null;if(a.importOnlyMeshes&&(e.skin||e.meshes)&&a.importMeshesNames&&a.importMeshesNames.length>0&&a.importMeshesNames.indexOf(e.name||"")===-1)return null;if(e.skin){if(e.meshes){const n=a.skins[e.skin],s=wi(a,e,e.meshes,t,e.babylonNode);s.skeleton=a.scene.getLastSkeletonById(e.skin),s.skeleton===null&&(s.skeleton=Vs(a,n,s,n.babylonSkeleton),n.babylonSkeleton||(n.babylonSkeleton=s.skeleton)),i=s}}else if(e.meshes)i=wi(a,e,e.mesh?[e.mesh]:e.meshes,t,e.babylonNode);else if(e.light&&!e.babylonNode&&!a.importOnlyMeshes){const n=a.lights[e.light];if(n){if(n.type==="ambient"){const s=n[n.type],r=new $i(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=V.FromArray(s.color)),i=r}else if(n.type==="directional"){const s=n[n.type],r=new Ce(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=V.FromArray(s.color)),i=r}else if(n.type==="point"){const s=n[n.type],r=new pt(e.light,A.Zero(),a.scene);r.name=e.name||"",s.color&&(r.diffuse=V.FromArray(s.color)),i=r}else if(n.type==="spot"){const s=n[n.type],r=new pe(e.light,A.Zero(),A.Zero(),0,0,a.scene);r.name=e.name||"",s.color&&(r.diffuse=V.FromArray(s.color)),s.fallOfAngle&&(r.angle=s.fallOfAngle),s.fallOffExponent&&(r.exponent=s.fallOffExponent),i=r}}}else if(e.camera&&!e.babylonNode&&!a.importOnlyMeshes){const n=a.cameras[e.camera];if(n){if(a.scene._blockEntityCollection=!!a.assetContainer,n.type==="orthographic"){const s=new We(e.camera,A.Zero(),a.scene,!1);s.name=e.name||"",s.mode=en.ORTHOGRAPHIC_CAMERA,s.attachControl(),i=s,s._parentContainer=a.assetContainer}else if(n.type==="perspective"){const s=n[n.type],r=new We(e.camera,A.Zero(),a.scene,!1);r.name=e.name||"",r.attachControl(),s.aspectRatio||(s.aspectRatio=a.scene.getEngine().getRenderWidth()/a.scene.getEngine().getRenderHeight()),s.znear&&s.zfar&&(r.maxZ=s.zfar,r.minZ=s.znear),i=r,r._parentContainer=a.assetContainer}a.scene._blockEntityCollection=!1}}if(!e.jointName){if(e.babylonNode)return e.babylonNode;if(i===null){a.scene._blockEntityCollection=!!a.assetContainer;const n=new se(e.name||"",a.scene);n._parentContainer=a.assetContainer,a.scene._blockEntityCollection=!1,e.babylonNode=n,i=n}}if(i!==null){if(e.matrix&&i instanceof se)Hs(i,e);else{const n=e.translation||[0,0,0],s=e.rotation||[0,0,0,1],r=e.scale||[1,1,1];zt(i,A.FromArray(n),Ee.FromArray(s),A.FromArray(r))}i.updateCache(!0),e.babylonNode=i}return i},dt=(a,e,t,i=!1)=>{const n=a.nodes[e];let s=null;if(a.importOnlyMeshes&&!i&&a.importMeshesNames?a.importMeshesNames.indexOf(n.name||"")!==-1||a.importMeshesNames.length===0?i=!0:i=!1:i=!0,!n.jointName&&i&&(s=ks(a,n,e),s!==null&&(s.id=e,s.parent=t)),n.children)for(let r=0;r<n.children.length;r++)dt(a,n.children[r],s,i)},Gi=a=>{let e=a.currentScene;if(e)for(let t=0;t<e.nodes.length;t++)dt(a,e.nodes[t],null);else for(const t in a.scenes){e=a.scenes[t];for(let i=0;i<e.nodes.length;i++)dt(a,e.nodes[i],null)}Bs(a);for(let t=0;t<a.scene.skeletons.length;t++){const i=a.scene.skeletons[t];a.scene.beginAnimation(i,0,Number.MAX_VALUE,!0,1)}},Xs=(a,e,t,i,n,s,r)=>{const o=s.values||n.parameters;for(const l in t){const c=t[l],f=c.type;if(f===ue.FLOAT_MAT2||f===ue.FLOAT_MAT3||f===ue.FLOAT_MAT4){if(c.semantic&&!c.source&&!c.node)ne.SetMatrix(e.scene,a,c,l,i.getEffect());else if(c.semantic&&(c.source||c.node)){let h=e.scene.getNodeByName(c.source||c.node||"");if(h===null&&(h=e.scene.getNodeById(c.source||c.node||"")),h===null)continue;ne.SetMatrix(e.scene,h,c,l,i.getEffect())}}else{const h=o[n.uniforms[l]];if(!h)continue;if(f===ue.SAMPLER_2D){const u=e.textures[s.values?h:c.value].babylonTexture;if(u==null)continue;i.getEffect().setTexture(l,u)}else ne.SetUniform(i.getEffect(),l,h,f)}}r(i)},Ys=(a,e,t,i,n)=>{const s=i.values||t.parameters,r=t.uniforms;for(const o in n){const l=n[o],c=l.type;let f=s[r[o]];if(f===void 0&&(f=l.value),!f)continue;const h=u=>_=>{l.value&&u&&(e.setTexture(u,_),delete n[u])};c===ue.SAMPLER_2D?re.LoadTextureAsync(a,i.values?f:l.value,h(o),()=>h(null)):l.value&&ne.SetUniform(e,o,i.values?f:l.value,c)&&delete n[o]}},zs=(a,e,t)=>(i,n)=>{e.dispose(!0),t("Cannot compile program named "+a.name+". Error: "+n+". Default material will be applied")},Ws=(a,e,t,i,n,s)=>r=>{Ys(a,e,t,i,n),e.onBind=o=>{Xs(o,a,n,e,t,i,s)}},Vi=(a,e,t)=>{for(const i in e.uniforms){const n=e.uniforms[i],s=e.parameters[n];if(a.currentIdentifier===i&&s.semantic&&!s.source&&!s.node){const r=rn.indexOf(s.semantic);if(r!==-1)return delete t[i],an[r]}}return a.currentIdentifier},Hi=a=>{for(const e in a.materials)re.LoadMaterialAsync(a,e,()=>{},()=>{})};class Me{static CreateRuntime(e,t,i){const n={extensions:{},accessors:{},buffers:{},bufferViews:{},meshes:{},lights:{},cameras:{},nodes:{},images:{},textures:{},shaders:{},programs:{},samplers:{},techniques:{},materials:{},animations:{},skins:{},extensionsUsed:[],scenes:{},buffersCount:0,shaderscount:0,scene:t,rootUrl:i,loadedBufferCount:0,loadedBufferViews:{},loadedShaderCount:0,importOnlyMeshes:!1,dummyNodes:[],assetContainer:null};return e.extensions&&fe(e.extensions,"extensions",n),e.extensionsUsed&&fe(e.extensionsUsed,"extensionsUsed",n),e.buffers&&Ps(e.buffers,n),e.bufferViews&&fe(e.bufferViews,"bufferViews",n),e.accessors&&fe(e.accessors,"accessors",n),e.meshes&&fe(e.meshes,"meshes",n),e.lights&&fe(e.lights,"lights",n),e.cameras&&fe(e.cameras,"cameras",n),e.nodes&&fe(e.nodes,"nodes",n),e.images&&fe(e.images,"images",n),e.textures&&fe(e.textures,"textures",n),e.shaders&&Ds(e.shaders,n),e.programs&&fe(e.programs,"programs",n),e.samplers&&fe(e.samplers,"samplers",n),e.techniques&&fe(e.techniques,"techniques",n),e.materials&&fe(e.materials,"materials",n),e.animations&&fe(e.animations,"animations",n),e.skins&&fe(e.skins,"skins",n),e.scenes&&(n.scenes=e.scenes),e.scene&&e.scenes&&(n.currentScene=e.scenes[e.scene]),n}static LoadBufferAsync(e,t,i,n,s){const r=e.buffers[t];w.IsBase64(r.uri)?setTimeout(()=>i(new Uint8Array(w.DecodeBase64(r.uri)))):w.LoadFile(e.rootUrl+r.uri,o=>i(new Uint8Array(o)),s,void 0,!0,o=>{o&&n(o.status+" "+o.statusText)})}static LoadTextureBufferAsync(e,t,i,n){const s=e.textures[t];if(!s||!s.source){n("");return}if(s.babylonTexture){i(null);return}const r=e.images[s.source];w.IsBase64(r.uri)?setTimeout(()=>i(new Uint8Array(w.DecodeBase64(r.uri)))):w.LoadFile(e.rootUrl+r.uri,o=>i(new Uint8Array(o)),void 0,void 0,!0,o=>{o&&n(o.status+" "+o.statusText)})}static CreateTextureAsync(e,t,i,n){const s=e.textures[t];if(s.babylonTexture){n(s.babylonTexture);return}const r=e.samplers[s.sampler],o=r.minFilter===Re.NEAREST_MIPMAP_NEAREST||r.minFilter===Re.NEAREST_MIPMAP_LINEAR||r.minFilter===Re.LINEAR_MIPMAP_NEAREST||r.minFilter===Re.LINEAR_MIPMAP_LINEAR,l=B.BILINEAR_SAMPLINGMODE,c=i==null?new Blob:new Blob([i]),f=URL.createObjectURL(c),h=()=>URL.revokeObjectURL(f),u=new B(f,e.scene,!o,!0,l,h,h);r.wrapS!==void 0&&(u.wrapU=ne.GetWrapMode(r.wrapS)),r.wrapT!==void 0&&(u.wrapV=ne.GetWrapMode(r.wrapT)),u.name=t,s.babylonTexture=u,n(u)}static LoadShaderStringAsync(e,t,i,n){const s=e.shaders[t];if(w.IsBase64(s.uri)){const r=atob(s.uri.split(",")[1]);i&&i(r)}else w.LoadFile(e.rootUrl+s.uri,i,void 0,void 0,!1,r=>{r&&n&&n(r.status+" "+r.statusText)})}static LoadMaterialAsync(e,t,i,n){const s=e.materials[t];if(!s.technique){n&&n("No technique found.");return}const r=e.techniques[s.technique];if(!r){e.scene._blockEntityCollection=!!e.assetContainer;const I=new Ri(t,e.scene);I._parentContainer=e.assetContainer,e.scene._blockEntityCollection=!1,I.diffuseColor=new V(.5,.5,.5),I.sideOrientation=le.CounterClockWiseSideOrientation,i(I);return}const o=e.programs[r.program],l=r.states,c=Ve.ShadersStore[o.vertexShader+"VertexShader"],f=Ve.ShadersStore[o.fragmentShader+"PixelShader"];let h="",u="";const _=new Bi(c),d=new Bi(f),E={},p=[],g=[],R=[];for(const I in r.uniforms){const O=r.uniforms[I],G=r.parameters[O];if(E[I]=G,G.semantic&&!G.node&&!G.source){const Q=rn.indexOf(G.semantic);Q!==-1?(p.push(an[Q]),delete E[I]):p.push(I)}else G.type===ue.SAMPLER_2D?R.push(I):p.push(I)}for(const I in r.attributes){const O=r.attributes[I],G=r.parameters[O];if(G.semantic){const Q=Ui(G);Q&&g.push(Q)}}for(;!_.isEnd()&&_.getNextToken();){if(_.currentToken!==He.IDENTIFIER){h+=_.currentString;continue}let O=!1;for(const G in r.attributes){const Q=r.attributes[G],X=r.parameters[Q];if(_.currentIdentifier===G&&X.semantic){h+=Ui(X),O=!0;break}}O||(h+=Vi(_,r,E))}for(;!d.isEnd()&&d.getNextToken();){if(d.currentToken!==He.IDENTIFIER){u+=d.currentString;continue}u+=Vi(d,r,E)}const M={vertex:o.vertexShader+t,fragment:o.fragmentShader+t},y={attributes:g,uniforms:p,samplers:R,needAlphaBlending:l&&l.enable&&l.enable.indexOf(3042)!==-1};Ve.ShadersStore[o.vertexShader+t+"VertexShader"]=h,Ve.ShadersStore[o.fragmentShader+t+"PixelShader"]=u;const N=new Ji(t,e.scene,M,y);if(N.onError=zs(o,N,n),N.onCompiled=Ws(e,N,r,s,E,i),N.sideOrientation=le.CounterClockWiseSideOrientation,l&&l.functions){const I=l.functions;I.cullFace&&I.cullFace[0]!==St.BACK&&(N.backFaceCulling=!1);const O=I.blendFuncSeparate;O&&(O[0]===J.SRC_ALPHA&&O[1]===J.ONE_MINUS_SRC_ALPHA&&O[2]===J.ONE&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_COMBINE:O[0]===J.ONE&&O[1]===J.ONE&&O[2]===J.ZERO&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_ONEONE:O[0]===J.SRC_ALPHA&&O[1]===J.ONE&&O[2]===J.ZERO&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_ADD:O[0]===J.ZERO&&O[1]===J.ONE_MINUS_SRC_COLOR&&O[2]===J.ONE&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_SUBTRACT:O[0]===J.DST_COLOR&&O[1]===J.ZERO&&O[2]===J.ONE&&O[3]===J.ONE?N.alphaMode=ke.ALPHA_MULTIPLY:O[0]===J.SRC_ALPHA&&O[1]===J.ONE_MINUS_SRC_COLOR&&O[2]===J.ONE&&O[3]===J.ONE&&(N.alphaMode=ke.ALPHA_MAXIMIZED))}}}let Ge=class{static RegisterExtension(e){if(Ge.Extensions[e.name]){w.Error('Tool with the same name "'+e.name+'" already exists');return}Ge.Extensions[e.name]=e}dispose(){}_importMeshAsync(e,t,i,n,s,r,o,l){return t.useRightHandedSystem=!0,re.LoadRuntimeAsync(t,i,n,c=>{c.assetContainer=s,c.importOnlyMeshes=!0,e===""?c.importMeshesNames=[]:typeof e=="string"?c.importMeshesNames=[e]:e&&!(e instanceof Array)?c.importMeshesNames=[e]:(c.importMeshesNames=[],w.Warn("Argument meshesNames must be of type string or string[]")),this._createNodes(c);const f=new Array,h=new Array;for(const u in c.nodes){const _=c.nodes[u];_.babylonNode instanceof $n&&f.push(_.babylonNode)}for(const u in c.skins){const _=c.skins[u];_.babylonSkeleton instanceof nt&&h.push(_.babylonSkeleton)}this._loadBuffersAsync(c,()=>{this._loadShadersAsync(c,()=>{Hi(c),Gi(c),!Z.IncrementalLoading&&r&&r(f,h)})}),Z.IncrementalLoading&&r&&r(f,h)},l),!0}importMeshAsync(e,t,i,n,s,r){return new Promise((o,l)=>{this._importMeshAsync(e,t,n,s,i,(c,f)=>{o({meshes:c,particleSystems:[],skeletons:f,animationGroups:[],lights:[],transformNodes:[],geometries:[]})},r,c=>{l(new Error(c))})})}_loadAsync(e,t,i,n,s,r){e.useRightHandedSystem=!0,re.LoadRuntimeAsync(e,t,i,o=>{re.LoadRuntimeExtensionsAsync(o,()=>{this._createNodes(o),this._loadBuffersAsync(o,()=>{this._loadShadersAsync(o,()=>{Hi(o),Gi(o),Z.IncrementalLoading||n()})}),Z.IncrementalLoading&&n()},r)},r)}loadAsync(e,t,i,n){return new Promise((s,r)=>{this._loadAsync(e,t,i,()=>{s()},n,o=>{r(new Error(o))})})}_loadShadersAsync(e,t){let i=!1;const n=(s,r)=>{re.LoadShaderStringAsync(e,s,o=>{o instanceof ArrayBuffer||(e.loadedShaderCount++,o&&(Ve.ShadersStore[s+(r.type===Ct.VERTEX?"VertexShader":"PixelShader")]=o),e.loadedShaderCount===e.shaderscount&&t())},()=>{w.Error("Error when loading shader program named "+s+" located at "+r.uri)})};for(const s in e.shaders){i=!0;const r=e.shaders[s];r?n.bind(this,s,r)():w.Error("No shader named: "+s)}i||t()}_loadBuffersAsync(e,t){let i=!1;const n=(s,r)=>{re.LoadBufferAsync(e,s,o=>{e.loadedBufferCount++,o&&(o.byteLength!=e.buffers[s].byteLength&&w.Error("Buffer named "+s+" is length "+o.byteLength+". Expected: "+r.byteLength),e.loadedBufferViews[s]=o),e.loadedBufferCount===e.buffersCount&&t()},()=>{w.Error("Error when loading buffer named "+s+" located at "+r.uri)})};for(const s in e.buffers){i=!0;const r=e.buffers[s];r?n.bind(this,s,r)():w.Error("No buffer named: "+s)}i||t()}_createNodes(e){let t=e.currentScene;if(t)for(let i=0;i<t.nodes.length;i++)dt(e,t.nodes[i],null);else for(const i in e.scenes){t=e.scenes[i];for(let n=0;n<t.nodes.length;n++)dt(e,t.nodes[n],null)}}};Ge.Extensions={};class re{constructor(e){this._name=e}get name(){return this._name}loadRuntimeAsync(e,t,i,n,s){return!1}loadRuntimeExtensionsAsync(e,t,i){return!1}loadBufferAsync(e,t,i,n,s){return!1}loadTextureBufferAsync(e,t,i,n){return!1}createTextureAsync(e,t,i,n,s){return!1}loadShaderStringAsync(e,t,i,n){return!1}loadMaterialAsync(e,t,i,n){return!1}static LoadRuntimeAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.loadRuntimeAsync(e,t,i,n,s),()=>{setTimeout(()=>{!n||n(Me.CreateRuntime(t.json,e,i))})})}static LoadRuntimeExtensionsAsync(e,t,i){re._ApplyExtensions(n=>n.loadRuntimeExtensionsAsync(e,t,i),()=>{setTimeout(()=>{t()})})}static LoadBufferAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.loadBufferAsync(e,t,i,n,s),()=>{Me.LoadBufferAsync(e,t,i,n,s)})}static LoadTextureAsync(e,t,i,n){re._LoadTextureBufferAsync(e,t,s=>{s&&re._CreateTextureAsync(e,t,s,i,n)},n)}static LoadShaderStringAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadShaderStringAsync(e,t,i,n),()=>{Me.LoadShaderStringAsync(e,t,i,n)})}static LoadMaterialAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadMaterialAsync(e,t,i,n),()=>{Me.LoadMaterialAsync(e,t,i,n)})}static _LoadTextureBufferAsync(e,t,i,n){re._ApplyExtensions(s=>s.loadTextureBufferAsync(e,t,i,n),()=>{Me.LoadTextureBufferAsync(e,t,i,n)})}static _CreateTextureAsync(e,t,i,n,s){re._ApplyExtensions(r=>r.createTextureAsync(e,t,i,n,s),()=>{Me.CreateTextureAsync(e,t,i,n)})}static _ApplyExtensions(e,t){for(const i in Ge.Extensions){const n=Ge.Extensions[i];if(e(n))return}t()}}Z._CreateGLTF1Loader=()=>new Ge;const Ks="binary_glTF";class ln extends re{constructor(){super("KHR_binary_glTF")}loadRuntimeAsync(e,t,i,n){const s=t.json.extensionsUsed;return!s||s.indexOf(this.name)===-1||!t.bin?!1:(this._bin=t.bin,n(Me.CreateRuntime(t.json,e,i)),!0)}loadBufferAsync(e,t,i,n){return e.extensionsUsed.indexOf(this.name)===-1||t!==Ks?!1:(this._bin.readAsync(0,this._bin.byteLength).then(i,s=>n(s.message)),!0)}loadTextureBufferAsync(e,t,i){const n=e.textures[t],s=e.images[n.source];if(!s.extensions||!(this.name in s.extensions))return!1;const r=s.extensions[this.name],o=e.bufferViews[r.bufferView],l=ne.GetBufferFromBufferView(e,o,0,o.byteLength,Ue.UNSIGNED_BYTE);return i(l),!0}loadShaderStringAsync(e,t,i){const n=e.shaders[t];if(!n.extensions||!(this.name in n.extensions))return!1;const s=n.extensions[this.name],r=e.bufferViews[s.bufferView],o=ne.GetBufferFromBufferView(e,r,0,r.byteLength,Ue.UNSIGNED_BYTE);return setTimeout(()=>{const l=ne.DecodeBufferToText(o);i(l)}),!0}}Ge.RegisterExtension(new ln);class cn extends re{constructor(){super("KHR_materials_common")}loadRuntimeExtensionsAsync(e){if(!e.extensions)return!1;const t=e.extensions[this.name];if(!t)return!1;const i=t.lights;if(i)for(const n in i){const s=i[n];switch(s.type){case"ambient":{const r=new $i(s.name,new A(0,1,0),e.scene),o=s.ambient;o&&(r.diffuse=V.FromArray(o.color||[1,1,1]));break}case"point":{const r=new pt(s.name,new A(10,10,10),e.scene),o=s.point;o&&(r.diffuse=V.FromArray(o.color||[1,1,1]));break}case"directional":{const r=new Ce(s.name,new A(0,-1,0),e.scene),o=s.directional;o&&(r.diffuse=V.FromArray(o.color||[1,1,1]));break}case"spot":{const r=s.spot;if(r){const o=new pe(s.name,new A(0,10,0),new A(0,-1,0),r.fallOffAngle||Math.PI,r.fallOffExponent||0,e.scene);o.diffuse=V.FromArray(r.color||[1,1,1])}break}default:w.Warn('GLTF Material Common extension: light type "'+s.type+"” not supported");break}}return!1}loadMaterialAsync(e,t,i,n){const s=e.materials[t];if(!s||!s.extensions)return!1;const r=s.extensions[this.name];if(!r)return!1;const o=new Ri(t,e.scene);return o.sideOrientation=le.CounterClockWiseSideOrientation,r.technique==="CONSTANT"&&(o.disableLighting=!0),o.backFaceCulling=r.doubleSided===void 0?!1:!r.doubleSided,o.alpha=r.values.transparency===void 0?1:r.values.transparency,o.specularPower=r.values.shininess===void 0?0:r.values.shininess,typeof r.values.ambient=="string"?this._loadTexture(e,r.values.ambient,o,"ambientTexture",n):o.ambientColor=V.FromArray(r.values.ambient||[0,0,0]),typeof r.values.diffuse=="string"?this._loadTexture(e,r.values.diffuse,o,"diffuseTexture",n):o.diffuseColor=V.FromArray(r.values.diffuse||[0,0,0]),typeof r.values.emission=="string"?this._loadTexture(e,r.values.emission,o,"emissiveTexture",n):o.emissiveColor=V.FromArray(r.values.emission||[0,0,0]),typeof r.values.specular=="string"?this._loadTexture(e,r.values.specular,o,"specularTexture",n):o.specularColor=V.FromArray(r.values.specular||[0,0,0]),!0}_loadTexture(e,t,i,n,s){Me.LoadTextureBufferAsync(e,t,r=>{Me.CreateTextureAsync(e,t,r,o=>i[n]=o)},s)}}Ge.RegisterExtension(new cn);const fo=Object.freeze(Object.defineProperty({__proto__:null,GLTFBinaryExtension:ln,GLTFLoaderBase:Me,GLTFLoader:Ge,GLTFLoaderExtension:re,get EComponentType(){return Ue},get EShaderType(){return Ct},get EParameterType(){return ue},get ETextureWrapMode(){return et},get ETextureFilterType(){return Re},get ETextureFormat(){return Yt},get ECullingType(){return St},get EBlendingFunction(){return J},GLTFUtils:ne,GLTFMaterialsCommonExtension:cn},Symbol.toStringTag,{value:"Module"}));class ct{constructor(){this.promise=new Promise((e,t)=>{this._resolve=e,this._reject=t})}get resolve(){return this._resolve}get reject(){return this._reject}}const Qs="postprocessVertexShader",js=`attribute vec2 position;
uniform vec2 scale;
varying vec2 vUV;
...
}`;k.ShadersStore[Js]=$s;ce.prototype.createRenderTargetCubeTexture=function(a,e){const t=this._createHardwareRenderTargetWrapper(!1,!0,a),i={generateMipMaps:!0,generateDepthBuffer:!0,generateStencilBuffer:!1,type:0,samplingMode:3,format:5,...e};i.generateStencilBuffer=i.generateDepthBuffer&&i.generateStencilBuffer,(i.type===1&&!this._caps.textureFloatLinearFiltering||i.type===2&&!this._caps.textureHalfFloatLinearFiltering)&&(i.samplingMode=1);const n=this._gl,s=new mt(this,Ne.RenderTarget);this._bindTextureDirectly(n.TEXTURE_CUBE_MAP,s,!0);const r=this._getSamplingParameters(i.samplingMode,i.generateMipMaps);i.type===1&&!this._caps.textureFloat&&(i.type=0,H.Warn("Float textures are not supported. Cube render target forced to TEXTURETYPE_UNESIGNED_BYTE type")),n.texParameteri(n.TEXTURE_CUBE_MAP,n.TEXTURE_MAG_FILTER,r.mag),n.texParameteri(n.TEXTURE_CUBE_MAP,n.TEXTURE_MIN_FILTER,r.min),n.texParameteri(n.TEXTURE_CUBE_MAP,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_CUBE_MAP,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE);for(let l=0;l<6;l++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,this._getRGBABufferInternalSizedFormat(i.type,i.format),a,a,0,this._getInternalFormat(i.format),this._getWebGLTextureType(i.type),null);const o=n.createFramebuffer();return this._bindUnboundFramebuffer(o),t._depthStencilBuffer=this._setupFramebufferDepthAttachments(i.generateStencilBuffer,i.generateDepthBuffer,a,a),i.generateMipMaps&&n.generateMipmap(n.TEXTURE_CUBE_MAP),this._bindTextureDirectly(n.TEXTURE_CUBE_MAP,null),this._bindUnboundFramebuffer(null),t._framebuffer=o,t._generateDepthBuffer=i.generateDepthBuffer,t._generateStencilBuffer=i.generateStencilBuffer,s.width=a,s.height=a,s.isReady=!0,s.isCube=!0,s.samples=1,s.generateMipMaps=i.generateMipMaps,s.samplingMode=i.samplingMode,s.type=i.type,s.format=i.format,this._internalTexturesCache.push(s),t.setTextures(s),t};const Gt={positions:[1,1,-1,1,-1,-1,1,-1],indices:[0,1,2,0,2,3]};class er{constructor(e,t=Gt){var i,n;this._fullscreenViewport=new ss(0,0,1,1);const s=(i=t.positions)!==null&&i!==void 0?i:Gt.positions,r=(n=t.indices)!==null&&n!==void 0?n:Gt.indices;this.engine=e,this._vertexBuffers={[b.PositionKind]:new b(e,s,b.PositionKind,!1,!1,2)},this._indexBuffer=e.createIndexBuffer(r),this._onContextRestoredObserver=e.onContextRestoredObservable.add(()=>{this._indexBuffer=e.createIndexBuffer(r);for(const o in this._vertexBuffers)this._vertexBuffers[o]._rebuild()})}setViewport(e=this._fullscreenViewport){this.engine.setViewport(e)}bindBuffers(e){this.engine.bindBuffers(this._vertexBuffers,this._indexBuffer,e)}applyEffectWrapper(e){this.engine.setState(!0),this.engine.depthCullingState.depthTest=!1,this.engine.stencilState.stencilTest=!1,this.engine.enableEffect(e._drawWrapper),this.bindBuffers(e.effect),e.onApplyObservable.notifyObservers({})}restoreStates(){this.engine.depthCullingState.depthTest=!0,this.engine.stencilState.stencilTest=!0}draw(){this.engine.drawElementsType(0,0,6)}_isRenderTargetTexture(e){return e.renderTarget!==void 0}render(e,t=null){if(!e.effect.isReady())return;this.setViewport();const i=t===null?null:this._isRenderTargetTexture(t)?t.renderTarget:t;i&&this.engine.bindFramebuffer(i),this.applyEffectWrapper(e),this.draw(),i&&this.engine.unBindFramebuffer(i),this.restoreStates()}dispose(){const e=this._vertexBuffers[b.PositionKind];e&&(e.dispose(),delete this._vertexBuffers[b.PositionKind]),this._indexBuffer&&this.engine._releaseBuffer(this._indexBuffer),this._onContextRestoredObserver&&(this.engine.onContextRestoredObservable.remove(this._onContextRestoredObserver),this._onContextRestoredObserver=null)}}class tr{constructor(e){this.onApplyObservable=new z;let t;const i=e.uniformNames||[];e.vertexShader?t={fragmentSource:e.fragmentShader,vertexSource:e.vertexShader,spectorName:e.name||"effectWrapper"}:(i.push("scale"),t={fragmentSource:e.fragmentShader,vertex:"postprocess",spectorName:e.name||"effectWrapper"},this.onApplyObservable.add(()=>{this.effect.setFloat2("scale",1,1)}));const n=e.defines?e.defines.join(`
`):"";this._drawWrapper=new tn(e.engine),e.useShaderStore?(t.fragment=t.fragmentSource,t.vertex||(t.vertex=t.vertexSource),delete t.fragmentSource,delete t.vertexSource,this.effect=e.engine.createEffect(t,e.attributeNames||["position"],i,e.samplerNames,n,void 0,e.onCompiled,void 0,void 0,e.shaderLanguage)):(this.effect=new Ve(t,e.attributeNames||["position"],i,e.samplerNames,e.engine,n,void 0,e.onCompiled,void 0,void 0,void 0,e.shaderLanguage),this._onContextRestoredObserver=e.engine.onContextRestoredObservable.add(()=>{this.effect._pipelineContext=null,this.effect._wasPreviouslyReady=!1,this.effect._prepareEffect()}))}get effect(){return this._drawWrapper.effect}set effect(e){this._drawWrapper.effect=e}dispose(){this._onContextRestoredObserver&&(this.effect.getEngine().onContextRestoredObservable.remove(this._onContextRestoredObserver),this._onContextRestoredObserver=null),this.effect.dispose()}}const fn="passPixelShader",hn=`varying vec2 vUV;
uniform sampler2D textureSampler;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) 
{
gl_FragColor=texture2D(textureSampler,vUV);
}`;k.ShadersStore[fn]=hn;const ki={name:fn,shader:hn};class he{static _CreateDumpRenderer(){if(!he._DumpToolsEngine){const e=document.createElement("canvas"),t=new ce(e,!1,{preserveDrawingBuffer:!0,depth:!1,stencil:!1,alpha:!0,premultipliedAlpha:!1,antialias:!1,failIfMajorPerformanceCaveat:!1});t.getCaps().parallelShaderCompile=void 0;const i=new er(t),n=new tr({engine:t,name:ki.name,fragmentShader:ki.shader,samplerNames:["textureSampler"]});he._DumpToolsEngine={canvas:e,engine:t,renderer:i,wrapper:n}}return he._DumpToolsEngine}static async DumpFramebuffer(e,t,i,n,s="image/png",r){const o=await i.readPixels(0,0,e,t),l=new Uint8Array(o.buffer);he.DumpData(e,t,l,n,s,r,!0)}static DumpDataAsync(e,t,i,n="image/png",s,r=!1,o=!1,l){return new Promise(c=>{he.DumpData(e,t,i,f=>c(f),n,s,r,o,l)})}static DumpData(e,t,i,n,s="image/png",r,o=!1,l=!1,c){const f=he._CreateDumpRenderer();if(f.engine.setSize(e,t,!0),i instanceof Float32Array){const u=new Uint8Array(i.length);let _=i.length;for(;_--;){const d=i[_];u[_]=d<0?0:d>1?1:Math.round(d*255)}i=u}const h=f.engine.createRawTexture(i,e,t,5,!1,!o,1);f.renderer.setViewport(),f.renderer.applyEffectWrapper(f.wrapper),f.wrapper.effect._bindTexture("textureSampler",h),f.renderer.draw(),l?w.ToBlob(f.canvas,u=>{const _=new FileReader;_.onload=d=>{const E=d.target.result;n&&n(E)},_.readAsArrayBuffer(u)},s,c):w.EncodeScreenshotCanvasData(f.canvas,n,s,r,c),h.dispose()}static Dispose(){he._DumpToolsEngine&&(he._DumpToolsEngine.wrapper.dispose(),he._DumpToolsEngine.renderer.dispose(),he._DumpToolsEngine.engine.dispose()),he._DumpToolsEngine=null}}const ir=()=>{w.DumpData=he.DumpData,w.DumpDataAsync=he.DumpDataAsync,w.DumpFramebuffer=he.DumpFramebuffer};ir();class we extends B{constructor(e,t,i,n=!1,s=!0,r=0,o=!1,l=B.TRILINEAR_SAMPLINGMODE,c=!0,f=!1,h=!1,u=5,_=!1,d,E,p=!1,g=!1){var R,M,y,N,I,O;let G;if(typeof n=="object"){const X=n;n=!!X.generateMipMaps,s=(R=X.doNotChangeAspectRatio)!==null&&R!==void 0?R:!0,r=(M=X.type)!==null&&M!==void 0?M:0,o=!!X.isCube,l=(y=X.samplingMode)!==null&&y!==void 0?y:B.TRILINEAR_SAMPLINGMODE,c=(N=X.generateDepthBuffer)!==null&&N!==void 0?N:!0,f=!!X.generateStencilBuffer,h=!!X.isMulti,u=(I=X.format)!==null&&I!==void 0?I:5,_=!!X.delayAllocation,d=X.samples,E=X.creationFlags,p=!!X.noColorAttachment,g=!!X.useSRGBBuffer,G=X.colorAttachment}if(super(null,i,!n,void 0,l,void 0,void 0,void 0,void 0,u),this._unObserveRenderList=null,this._renderListHasChanged=(X,ie)=>{var je;const Oi=this._renderList?this._renderList.length:0;(ie===0&&Oi>0||Oi===0)&&((je=this.getScene())===null||je===void 0||je.meshes.forEach(kn=>{kn._markSubMeshesAsLightDirty()}))},this.renderParticles=!0,this.renderSprites=!1,this.forceLayerMaskCheck=!1,this.ignoreCameraViewport=!1,this.onBeforeBindObservable=new z,this.onAfterUnbindObservable=new z,this.onBeforeRenderObservable=new z,this.onAfterRenderObservable=new z,this.onClearObservable=new z,this.onResizeObservable=new z,this._cleared=!1,this.skipInitialClear=!1,this._currentRefreshId=-1,this._refreshRate=1,this._samples=1,this._canRescale=!0,this._renderTarget=null,this.boundingBoxPosition=A.Zero(),i=this.getScene(),!i)return;const Q=this.getScene().getEngine();this._coordinatesMode=B.PROJECTION_MODE,this.renderList=new Array,this.name=e,this.isRenderTarget=!0,this._initialSizeParameter=t,this._renderPassIds=[],this._isCubeData=o,this._processSizeParameter(t),this.renderPassId=this._renderPassIds[0],this._resizeObserver=Q.onResizeObservable.add(()=>{}),this._generateMipMaps=!!n,this._doNotChangeAspectRatio=s,this._renderingManager=new rs(i),this._renderingManager._useSceneAutoClearSetup=!0,!h&&(this._renderTargetOptions={generateMipMaps:n,type:r,format:(O=this._format)!==null&&O!==void 0?O:void 0,samplingMode:this.samplingMode,generateDepthBuffer:c,generateStencilBuffer:f,samples:d,creationFlags:E,noColorAttachment:p,useSRGBBuffer:g,colorAttachment:G},this.samplingMode===B.NEAREST_SAMPLINGMODE&&(this.wrapU=B.CLAMP_ADDRESSMODE,this.wrapV=B.CLAMP_ADDRESSMODE),_||(o?(this._renderTarget=i.getEngine().createRenderTargetCubeTexture(this.getRenderSize(),this._renderTargetOptions),this.coordinatesMode=B.INVCUBIC_MODE,this._textureMatrix=Y.Identity()):this._renderTarget=i.getEngine().createRenderTargetTexture(this._size,this._renderTargetOptions),this._texture=this._renderTarget.texture,d!==void 0&&(this.samples=d)))}get renderList(){return this._renderList}set renderList(e){this._unObserveRenderList&&(this._unObserveRenderList(),this._unObserveRenderList=null),e&&(this._unObserveRenderList=as(e,this._renderListHasChanged)),this._renderList=e}get postProcesses(){return this._postProcesses}get _prePassEnabled(){return!!this._prePassRenderTarget&&this._prePassRenderTarget.enabled}set onAfterUnbind(e){this._onAfterUnbindObserver&&this.onAfterUnbindObservable.remove(this._onAfterUnbindObserver),this._onAfterUnbindObserver=this.onAfterUnbindObservable.add(e)}set onBeforeRender(e){this._onBeforeRenderObserver&&this.onBeforeRenderObservable.remove(this._onBeforeRenderObserver),this._onBeforeRenderObserver=this.onBeforeRenderObservable.add(e)}set onAfterRender(e){this._onAfterRenderObserver&&this.onAfterRenderObservable.remove(this._onAfterRenderObserver),this._onAfterRenderObserver=this.onAfterRenderObservable.add(e)}set onClear(e){this._onClearObserver&&this.onClearObservable.remove(this._onClearObserver),this._onClearObserver=this.onClearObservable.add(e)}get renderPassIds(){return this._renderPassIds}get currentRefreshId(){return this._currentRefreshId}setMaterialForRendering(e,t){let i;Array.isArray(e)?i=e:i=[e];for(let n=0;n<i.length;++n)for(let s=0;s<this._renderPassIds.length;++s)i[n].setMaterialForRenderPass(this._renderPassIds[s],t!==void 0?Array.isArray(t)?t[s]:t:void 0)}get renderTargetOptions(){return this._renderTargetOptions}get renderTarget(){return this._renderTarget}_onRatioRescale(){this._sizeRatio&&this.resize(this._initialSizeParameter)}set boundingBoxSize(e){if(this._boundingBoxSize&&this._boundingBoxSize.equals(e))return;this._boundingBoxSize=e;const t=this.getScene();t&&t.markAllMaterialsAsDirty(1)}get boundingBoxSize(){return this._boundingBoxSize}get depthStencilTexture(){var e,t;return(t=(e=this._renderTarget)===null||e===void 0?void 0:e._depthStencilTexture)!==null&&t!==void 0?t:null}createDepthStencilTexture(e=0,t=!0,i=!1,n=1,s=14){var r;(r=this._renderTarget)===null||r===void 0||r.createDepthStencilTexture(e,t,i,n,s)}_releaseRenderPassId(){if(this._scene){const e=this._scene.getEngine();for(let t=0;t<this._renderPassIds.length;++t)e.releaseRenderPassId(this._renderPassIds[t])}this._renderPassIds=[]}_createRenderPassId(){this._releaseRenderPassId();const e=this._scene.getEngine(),t=this._isCubeData?6:this.getRenderLayers()||1;for(let i=0;i<t;++i)this._renderPassIds[i]=e.createRenderPassId(`RenderTargetTexture - ${this.name}#${i}`)}_processSizeParameter(e){if(e.ratio){this._sizeRatio=e.ratio;const t=this._getEngine();this._size={width:this._bestReflectionRenderTargetDimension(t.getRenderWidth(),this._sizeRatio),height:this._bestReflectionRenderTargetDimension(t.getRenderHeight(),this._sizeRatio)}}else this._size=e;this._createRenderPassId()}get samples(){var e,t;return(t=(e=this._renderTarget)===null||e===void 0?void 0:e.samples)!==null&&t!==void 0?t:this._samples}set samples(e){this._renderTarget&&(this._samples=this._renderTarget.setSamples(e))}resetRefreshCounter(){this._currentRefreshId=-1}get refreshRate(){return this._refreshRate}set refreshRate(e){this._refreshRate=e,this.resetRefreshCounter()}addPostProcess(e){if(!this._postProcessManager){const t=this.getScene();if(!t)return;this._postProcessManager=new os(t),this._postProcesses=new Array}this._postProcesses.push(e),this._postProcesses[0].autoClear=!1}clearPostProcesses(e=!1){if(!!this._postProcesses){if(e)for(const t of this._postProcesses)t.dispose();this._postProcesses=[]}}removePostProcess(e){if(!this._postProcesses)return;const t=this._postProcesses.indexOf(e);t!==-1&&(this._postProcesses.splice(t,1),this._postProcesses.length>0&&(this._postProcesses[0].autoClear=!1))}_shouldRender(){return this._currentRefreshId===-1?(this._currentRefreshId=1,!0):this.refreshRate===this._currentRefreshId?(this._currentRefreshId=1,!0):(this._currentRefreshId++,!1)}getRenderSize(){return this.getRenderWidth()}getRenderWidth(){return this._size.width?this._size.width:this._size}getRenderHeight(){return this._size.width?this._size.height:this._size}getRenderLayers(){const e=this._size.layers;return e||0}disableRescaling(){this._canRescale=!1}get canRescale(){return this._canRescale}scale(e){const t=Math.max(1,this.getRenderSize()*e);this.resize(t)}getReflectionTextureMatrix(){return this.isCube?this._textureMatrix:super.getReflectionTextureMatrix()}resize(e){var t;const i=this.isCube;(t=this._renderTarget)===null||t===void 0||t.dispose(),this._renderTarget=null;const n=this.getScene();!n||(this._processSizeParameter(e),i?this._renderTarget=n.getEngine().createRenderTargetCubeTexture(this.getRenderSize(),this._renderTargetOptions):this._renderTarget=n.getEngine().createRenderTargetTexture(this._size,this._renderTargetOptions),this._texture=this._renderTarget.texture,this._renderTargetOptions.samples!==void 0&&(this.samples=this._renderTargetOptions.samples),this.onResizeObservable.hasObservers()&&this.onResizeObservable.notifyObservers(this))}render(e=!1,t=!1){this._render(e,t)}isReadyForRendering(){return this._render(!1,!1,!0)}_render(e=!1,t=!1,i=!1){var n;const s=this.getScene();if(!s)return i;const r=s.getEngine();if(this.useCameraPostProcesses!==void 0&&(e=this.useCameraPostProcesses),this._waitingRenderList){this.renderList=[];for(let h=0;h<this._waitingRenderList.length;h++){const u=this._waitingRenderList[h],_=s.getMeshById(u);_&&this.renderList.push(_)}this._waitingRenderList=void 0}if(this.renderListPredicate){this.renderList?this.renderList.length=0:this.renderList=[];const h=this.getScene();if(!h)return i;const u=h.meshes;for(let _=0;_<u.length;_++){const d=u[_];this.renderListPredicate(d)&&this.renderList.push(d)}}const o=r.currentRenderPassId;this.onBeforeBindObservable.notifyObservers(this);const l=(n=this.activeCamera)!==null&&n!==void 0?n:s.activeCamera,c=s.activeCamera;l&&(l!==s.activeCamera&&(s.setTransformMatrix(l.getViewMatrix(),l.getProjectionMatrix(!0)),s.activeCamera=l),r.setViewport(l.viewport,this.getRenderWidth(),this.getRenderHeight())),this._defaultRenderListPrepared=!1;let f=i;if(i){s.getViewMatrix()||s.updateTransformMatrix();const h=this.is2DArray?this.getRenderLayers():this.isCube?6:1;for(let u=0;u<h&&f;u++){let _=null;const d=this.renderList?this.renderList:s.getActiveMeshes().data,E=this.renderList?this.renderList.length:s.getActiveMeshes().length;r.currentRenderPassId=this._renderPassIds[u],this.onBeforeRenderObservable.notifyObservers(u),this.getCustomRenderList&&(_=this.getCustomRenderList(u,d,E)),_||(_=d),this._doNotChangeAspectRatio||s.updateTransformMatrix(!0);for(let p=0;p<_.length&&f;++p){const g=_[p];if(!(!g.isEnabled()||g.isBlocked||!g.isVisible||!g.subMeshes)){if(this.customIsReadyFunction){if(!this.customIsReadyFunction(g,this.refreshRate,i)){f=!1;continue}}else if(!g.isReady(!0)){f=!1;continue}}}this.onAfterRenderObservable.notifyObservers(u),(this.is2DArray||this.isCube)&&(s.incrementRenderId(),s.resetCachedMaterial())}}else if(this.is2DArray)for(let h=0;h<this.getRenderLayers();h++)this._renderToTarget(0,e,t,h,l),s.incrementRenderId(),s.resetCachedMaterial();else if(this.isCube)for(let h=0;h<6;h++)this._renderToTarget(h,e,t,void 0,l),s.incrementRenderId(),s.resetCachedMaterial();else this._renderToTarget(0,e,t,void 0,l);return this.onAfterUnbindObservable.notifyObservers(this),r.currentRenderPassId=o,c&&(s.activeCamera=c,(s.getEngine().scenes.length>1||this.activeCamera&&this.activeCamera!==s.activeCamera)&&s.setTransformMatrix(s.activeCamera.getViewMatrix(),s.activeCamera.getProjectionMatrix(!0)),r.setViewport(s.activeCamera.viewport)),s.resetCachedMaterial(),f}_bestReflectionRenderTargetDimension(e,t){const n=e*t,s=D.NearestPOT(n+128*128/(128+n));return Math.min(D.FloorPOT(e),s)}_prepareRenderingManager(e,t,i,n){const s=this.getScene();if(!s)return;this._renderingManager.reset();const r=s.getRenderId();for(let o=0;o<t;o++){const l=e[o];if(l&&!l.isBlocked){if(this.customIsReadyFunction){if(!this.customIsReadyFunction(l,this.refreshRate,!1)){this.resetRefreshCounter();continue}}else if(!l.isReady(this.refreshRate===0)){this.resetRefreshCounter();continue}if(!l._internalAbstractMeshDataInfo._currentLODIsUpToDate&&s.activeCamera&&(l._internalAbstractMeshDataInfo._currentLOD=s.customLODSelector?s.customLODSelector(l,this.activeCamera||s.activeCamera):l.getLOD(this.activeCamera||s.activeCamera),l._internalAbstractMeshDataInfo._currentLODIsUpToDate=!0),!l._internalAbstractMeshDataInfo._currentLOD)continue;let c=l._internalAbstractMeshDataInfo._currentLOD;c._preActivateForIntermediateRendering(r);let f;if(n&&i?f=(l.layerMask&i.layerMask)===0:f=!1,l.isEnabled()&&l.isVisible&&l.subMeshes&&!f&&(c!==l&&c._activate(r,!0),l._activate(r,!0)&&l.subMeshes.length)){l.isAnInstance?l._internalAbstractMeshDataInfo._actAsRegularMesh&&(c=l):c._internalAbstractMeshDataInfo._onlyForInstancesIntermediate=!1,c._internalAbstractMeshDataInfo._isActiveIntermediate=!0;for(let h=0;h<c.subMeshes.length;h++){const u=c.subMeshes[h];this._renderingManager.dispatch(u,c)}}}}for(let o=0;o<s.particleSystems.length;o++){const l=s.particleSystems[o],c=l.emitter;!l.isStarted()||!c||!c.position||!c.isEnabled()||e.indexOf(c)>=0&&this._renderingManager.dispatchParticles(l)}}_bindFrameBuffer(e=0,t=0){const i=this.getScene();if(!i)return;const n=i.getEngine();this._renderTarget&&n.bindFramebuffer(this._renderTarget,this.isCube?e:void 0,void 0,void 0,this.ignoreCameraViewport,0,t)}_unbindFrameBuffer(e,t){!this._renderTarget||e.unBindFramebuffer(this._renderTarget,this.isCube,()=>{this.onAfterRenderObservable.notifyObservers(t)})}_prepareFrame(e,t,i,n){this._postProcessManager?this._prePassEnabled||this._postProcessManager._prepareFrame(this._texture,this._postProcesses):(!n||!e.postProcessManager._prepareFrame(this._texture))&&this._bindFrameBuffer(t,i)}_renderToTarget(e,t,i,n=0,s=null){var r,o,l,c,f,h;const u=this.getScene();if(!u)return;const _=u.getEngine();if((r=_._debugPushGroup)===null||r===void 0||r.call(_,`render to face #${e} layer #${n}`,1),this._prepareFrame(u,e,n,t),this.is2DArray?(_.currentRenderPassId=this._renderPassIds[n],this.onBeforeRenderObservable.notifyObservers(n)):(_.currentRenderPassId=this._renderPassIds[e],this.onBeforeRenderObservable.notifyObservers(e)),_.snapshotRendering&&_.snapshotRenderingMode===1)this.onClearObservable.hasObservers()?this.onClearObservable.notifyObservers(_):this.skipInitialClear||_.clear(this.clearColor||u.clearColor,!0,!0,!0);else{let E=null;const p=this.renderList?this.renderList:u.getActiveMeshes().data,g=this.renderList?this.renderList.length:u.getActiveMeshes().length;this.getCustomRenderList&&(E=this.getCustomRenderList(this.is2DArray?n:e,p,g)),E?this._prepareRenderingManager(E,E.length,s,this.forceLayerMaskCheck):(this._defaultRenderListPrepared||(this._prepareRenderingManager(p,g,s,!this.renderList||this.forceLayerMaskCheck),this._defaultRenderListPrepared=!0),E=p);for(const M of u._beforeRenderTargetClearStage)M.action(this,e,n);this.onClearObservable.hasObservers()?this.onClearObservable.notifyObservers(_):this.skipInitialClear||_.clear(this.clearColor||u.clearColor,!0,!0,!0),this._doNotChangeAspectRatio||u.updateTransformMatrix(!0);for(const M of u._beforeRenderTargetDrawStage)M.action(this,e,n);this._renderingManager.render(this.customRenderFunction,E,this.renderParticles,this.renderSprites);for(const M of u._afterRenderTargetDrawStage)M.action(this,e,n);const R=(l=(o=this._texture)===null||o===void 0?void 0:o.generateMipMaps)!==null&&l!==void 0?l:!1;this._texture&&(this._texture.generateMipMaps=!1),this._postProcessManager?this._postProcessManager._finalizeFrame(!1,(c=this._renderTarget)!==null&&c!==void 0?c:void 0,e,this._postProcesses,this.ignoreCameraViewport):t&&u.postProcessManager._finalizeFrame(!1,(f=this._renderTarget)!==null&&f!==void 0?f:void 0,e);for(const M of u._afterRenderTargetPostProcessStage)M.action(this,e,n);this._texture&&(this._texture.generateMipMaps=R),this._doNotChangeAspectRatio||u.updateTransformMatrix(!0),i&&he.DumpFramebuffer(this.getRenderWidth(),this.getRenderHeight(),_)}this._unbindFrameBuffer(_,e),this._texture&&this.isCube&&e===5&&_.generateMipMapsForCubemap(this._texture),(h=_._debugPopGroup)===null||h===void 0||h.call(_,1)}setRenderingOrder(e,t=null,i=null,n=null){this._renderingManager.setRenderingOrder(e,t,i,n)}setRenderingAutoClearDepthStencil(e,t){this._renderingManager.setRenderingAutoClearDepthStencil(e,t),this._renderingManager._useSceneAutoClearSetup=!1}clone(){const e=this.getSize(),t=new we(this.name,e,this.getScene(),this._renderTargetOptions.generateMipMaps,this._doNotChangeAspectRatio,this._renderTargetOptions.type,this.isCube,this._renderTargetOptions.samplingMode,this._renderTargetOptions.generateDepthBuffer,this._renderTargetOptions.generateStencilBuffer,void 0,this._renderTargetOptions.format,void 0,this._renderTargetOptions.samples);return t.hasAlpha=this.hasAlpha,t.level=this.level,t.coordinatesMode=this.coordinatesMode,this.renderList&&(t.renderList=this.renderList.slice(0)),t}serialize(){if(!this.name)return null;const e=super.serialize();if(e.renderTargetSize=this.getRenderSize(),e.renderList=[],this.renderList)for(let t=0;t<this.renderList.length;t++)e.renderList.push(this.renderList[t].id);return e}disposeFramebufferObjects(){var e;(e=this._renderTarget)===null||e===void 0||e.dispose(!0)}releaseInternalTexture(){var e;(e=this._renderTarget)===null||e===void 0||e.releaseTextures(),this._texture=null}dispose(){var e;this.onResizeObservable.clear(),this.onClearObservable.clear(),this.onAfterRenderObservable.clear(),this.onAfterUnbindObservable.clear(),this.onBeforeBindObservable.clear(),this.onBeforeRenderObservable.clear(),this._postProcessManager&&(this._postProcessManager.dispose(),this._postProcessManager=null),this._prePassRenderTarget&&this._prePassRenderTarget.dispose(),this._releaseRenderPassId(),this.clearPostProcesses(!0),this._resizeObserver&&(this.getScene().getEngine().onResizeObservable.remove(this._resizeObserver),this._resizeObserver=null),this.renderList=null;const t=this.getScene();if(!t)return;let i=t.customRenderTargets.indexOf(this);i>=0&&t.customRenderTargets.splice(i,1);for(const n of t.cameras)i=n.customRenderTargets.indexOf(this),i>=0&&n.customRenderTargets.splice(i,1);(e=this._renderTarget)===null||e===void 0||e.dispose(),this._renderTarget=null,this._texture=null,super.dispose()}_rebuild(){this.refreshRate===we.REFRESHRATE_RENDER_ONCE&&(this.refreshRate=we.REFRESHRATE_RENDER_ONCE),this._postProcessManager&&this._postProcessManager._rebuild()}freeRenderingGroups(){this._renderingManager&&this._renderingManager.freeRenderingGroups()}getViewCount(){return 1}}we.REFRESHRATE_RENDER_ONCE=0;we.REFRESHRATE_RENDER_ONEVERYFRAME=1;we.REFRESHRATE_RENDER_ONEVERYTWOFRAMES=2;B._CreateRenderTargetTexture=(a,e,t,i,n)=>new we(a,e,t,i);const nr="passCubePixelShader",sr=`varying vec2 vUV;
...
`;k.IncludesShadersStore[fr]=hr;const ur="pbrUboDeclaration",dr=`layout(std140,column_major) uniform;
uniform Material {
vec2 vAlbedoInfos;
vec4 vAmbientInfos;
vec2 vOpacityInfos;
...
`;k.IncludesShadersStore[ur]=dr;const _r="pbrFragmentExtraDeclaration",Er=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;k.IncludesShadersStore[_r]=Er;const mr="samplerFragmentAlternateDeclaration",pr=`#ifdef _DEFINENAME_
...
#endif
#endif
`;k.IncludesShadersStore[mr]=pr;const Ar="pbrFragmentSamplersDeclaration",Tr=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;k.IncludesShadersStore[Ar]=Tr;const gr="subSurfaceScatteringFunctions",Rr=`bool testLightingForSSS(float diffusionProfile)
{
return diffusionProfile<1.;
}`;k.IncludesShadersStore[gr]=Rr;const Cr="importanceSampling",Sr=`vec3 hemisphereCosSample(vec2 u) {
float phi=2.*PI*u.x;
...
return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);
}`;k.IncludesShadersStore[Cr]=Sr;const Ir="pbrHelperFunctions",vr=`#define RECIPROCAL_PI2 0.15915494
...
#endif
`;k.IncludesShadersStore[Ir]=vr;const xr="harmonicsFunctions",Mr=`#ifdef USESPHERICALFROMREFLECTIONMAP
#ifdef SPHERICAL_HARMONICS
...
#endif
#endif
`;k.IncludesShadersStore[xr]=Mr;const Nr="pbrDirectLightingSetupFunctions",Or=`struct preLightingInfo
{
vec3 lightOffset;
...
#endif
return result;
}`;k.IncludesShadersStore[Nr]=Or;const yr="pbrDirectLightingFalloffFunctions",br=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
{
...
#endif
}`;k.IncludesShadersStore[yr]=br;const Lr="pbrBRDFFunctions",Pr=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;k.IncludesShadersStore[Lr]=Pr;const Dr="hdrFilteringFunctions",Fr=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;k.IncludesShadersStore[Dr]=Fr;const Br="pbrDirectLightingFunctions",Ur=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{
vec3 diffuse;
#ifdef SPECULARTERM
...
#endif
`;k.IncludesShadersStore[Br]=Ur;const wr="pbrIBLFunctions",Gr=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;k.IncludesShadersStore[wr]=Gr;const Vr="pbrBlockAlbedoOpacity",Hr=`struct albedoOpacityOutParams
{
vec3 surfaceAlbedo;
float alpha;
};
...
`;k.IncludesShadersStore[Vr]=Hr;const kr="pbrBlockReflectivity",Xr=`struct reflectivityOutParams
{
float microSurface;
float roughness;
...
`;k.IncludesShadersStore[kr]=Xr;const Yr="pbrBlockAmbientOcclusion",zr=`struct ambientOcclusionOutParams
{
vec3 ambientOcclusionColor;
#if DEBUGMODE>0
...
`;k.IncludesShadersStore[Yr]=zr;const Wr="pbrBlockAlphaFresnel",Kr=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;k.IncludesShadersStore[Wr]=Kr;const Qr="pbrBlockAnisotropic",jr=`#ifdef ANISOTROPIC
...
#endif
`;k.IncludesShadersStore[Qr]=jr;const qr="pbrBlockReflection",Zr=`#ifdef REFLECTION
...
#endif
`;k.IncludesShadersStore[qr]=Zr;const Jr="pbrBlockSheen",$r=`#ifdef SHEEN
...
#endif
`;k.IncludesShadersStore[Jr]=$r;const ea="pbrBlockClearcoat",ta=`struct clearcoatOutParams
{
...
#endif
`;k.IncludesShadersStore[ea]=ta;const ia="pbrBlockIridescence",na=`struct iridescenceOutParams
{
float iridescenceIntensity;
...
#endif
`;k.IncludesShadersStore[ia]=na;const sa="pbrBlockSubSurface",ra=`struct subSurfaceOutParams
{
...
#endif
`;k.IncludesShadersStore[sa]=ra;const aa="pbrBlockNormalGeometric",oa=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;k.IncludesShadersStore[aa]=oa;const la="pbrBlockNormalFinal",ca=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;k.IncludesShadersStore[la]=ca;const fa="pbrBlockLightmapInit",ha=`#ifdef LIGHTMAP
...
#endif
`;k.IncludesShadersStore[fa]=ha;const ua="pbrBlockGeometryInfo",da=`float NdotVUnclamped=dot(normalW,viewDirectionW);
...
#endif
#endif
`;k.IncludesShadersStore[ua]=da;const _a="pbrBlockReflectance0",Ea=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);
...
#endif
`;k.IncludesShadersStore[_a]=Ea;const ma="pbrBlockReflectance",pa=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;k.IncludesShadersStore[ma]=pa;const Aa="pbrBlockDirectLighting",Ta=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;k.IncludesShadersStore[Aa]=Ta;const ga="pbrBlockFinalLitComponents",Ra=`#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;k.IncludesShadersStore[ga]=Ra;const Ca="pbrBlockFinalUnlitComponents",Sa=`vec3 finalDiffuse=diffuseBase;
...
`;k.IncludesShadersStore[Ca]=Sa;const Ia="pbrBlockFinalColorComposition",va=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;k.IncludesShadersStore[Ia]=va;const xa="pbrBlockImageProcessing",Ma=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;k.IncludesShadersStore[xa]=Ma;const Na="pbrDebug",Oa=`#if DEBUGMODE>0
...
#endif
`;k.IncludesShadersStore[Na]=Oa;const ya="pbrPixelShader",ba=`#if defined(BUMP) || !defined(NORMAL) || defined(FORCENORMALFORWARD) || defined(SPECULARAA) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
`;k.ShadersStore[ya]=ba;const La="pbrVertexDeclaration",Pa=`uniform mat4 view;
...
`;k.IncludesShadersStore[La]=Pa;const Da="pbrVertexShader",Fa=`precision highp float;
