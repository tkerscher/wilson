...
// export interface SolidMappedColorMaterial {
//     material: NodeMaterial,
//     updateScalar: (value: number) => void
// }

export function createSolidMappedColorMaterial(
    scene: Scene,
...
}
{
    ...
    //Inputs
    const colorScalar = new InputBlock("colorScalar");
    colorScalar.visibleInInspector = true;
    colorScalar.value = 0.0;
    const updateScalar = (value: number) => colorScalar.value = value;
    ...
    colorScalar.output.connectTo(mapOffset.left);
    ...
    const material = new NodeMaterial("solidMappedColor", scene);
